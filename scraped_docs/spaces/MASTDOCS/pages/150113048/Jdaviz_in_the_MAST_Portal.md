---
title: "MAST Document"
source_url: "https://outerspace.stsci.edu/spaces/MASTDOCS/pages/150113048/Jdaviz+in+the+MAST+Portal"
date_accessed: "2026-03-11T11:35:13.802124"
---

<!-- CHUNK 1 START -->
This chapter will summarize the MAST-Jdaviz workflow: searching for spectroscopic data in MAST, using the Jdaviz interface, and visualizing the science products.
**In this chapter...**
...
<!-- CHUNK 2 START -->
<!-- Metadata: {"Header 1": "Using the MAST Portal"} -->
This chapter requires some familiarity with MAST [Portal searches](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94962885/Searching).
If you are analyzing JWST data, it may also be helpful to know about:
* JWST data product types. See [Science Data Products](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products).
* [JWST science data overview](https://jwst-docs.stsci.edu/accessing-jwst-data/jwst-science-data-overview#JWSTScienceDataOverview-assocAssociations)  
* * *
