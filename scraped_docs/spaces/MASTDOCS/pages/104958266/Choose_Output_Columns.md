---
title: "MAST Document"
source_url: "https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958266/Choose+Output+Columns"
date_accessed: "2026-03-11T11:34:09.707563"
---

<!-- CHUNK 1 START -->
**On this page...**
* 1[Features and Functionality](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958266/Choose+Output+Columns#ChooseOutputColumns-FeaturesandFunctionality)
* 1.1[Preset Output Columns](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958266/Choose+Output+Columns#ChooseOutputColumns-preset_ocolPresetOutputColumns)
* 1.2[Individual Output Columns](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958266/Choose+Output+Columns#ChooseOutputColumns-choose_ocolIndividualOutputColumns)
* 2[For Further Reading...](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958266/Choose+Output+Columns#ChooseOutputColumns-ForFurtherReading...)

<!-- CHUNK 1 END -->

<!-- CHUNK 2 START -->
<!-- Metadata: {"Header 1": "Features and Functionality"} -->
The **Choose Output Columns** component is used to include or exclude available columns, individually or in bulk, to the search results table.
* * *
The selection buttons enable short-cuts to change the columns that will be included in the search results. **Select Recommended** will choose a subset of the columns that MAST has defined as the most common and useful ones to include. **Select All** ![](https://outerspace.stsci.edu/download/thumbnails/104958266/select_all.png?version=1&modificationDate=1629950739458&api=v2) and **Select None** ![](https://outerspace.stsci.edu/download/thumbnails/104958266/select_none.png?version=1&modificationDate=1629950739478&api=v2) buttons will include all or none of the columns, respectively. **Select****None** followed by [Choosing Output Columns](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958266/Choose+Output+Columns#ChooseOutputColumns-choose_ocol) (see below) can be used to customize the output columns when only a small number are desired.

<!-- CHUNK 2 END -->

<!-- CHUNK 3 START -->
<!-- Metadata: {"Header 1": "Features and Functionality", "Header 2": "Individual Output Columns"} -->
...
The following video snippet shows how to select output columns for display.
* * *
...
* [Search Results](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/107840287/Search+Results+Page) output table  
