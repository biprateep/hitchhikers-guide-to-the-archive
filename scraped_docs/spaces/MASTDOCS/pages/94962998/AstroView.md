---
title: "MAST Document"
source_url: "https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94962998/AstroView"
date_accessed: "2026-03-11T11:36:22.048050"
---

<!-- CHUNK 1 START -->
**On this page...**
* 1[Overview](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94962998/AstroView#AstroView-Overview)
* 1.1[Observation Footprints](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94962998/AstroView#AstroView-ObservationFootprints)
* 1.1.1[Footprint Selection](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94962998/AstroView#AstroView-FootprintSelection)
* 1.2[Background Survey](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94962998/AstroView#AstroView-BackgroundSurvey)
* 1.3[Pan, Zoom, and Coordinates](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94962998/AstroView#AstroView-Pan,Zoom,andCoordinates)
* 2[For Further Reading...](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94962998/AstroView#AstroView-ForFurtherReading...)

<!-- CHUNK 1 END -->

<!-- CHUNK 2 START -->
<!-- Metadata: {"Header 1": "Overview"} -->
The AstroView tool is an all-sky viewing component of the Portal. This view can be panned, zoomed, and the background image can be switched to one of several background sky surveys. The AstroView tool may be hidden by clicking the double-arrow icon ![](https://outerspace.stsci.edu/download/thumbnails/94962998/button_doubleArrow.png?version=1&modificationDate=1615210143711&api=v2).

<!-- CHUNK 2 END -->

<!-- CHUNK 3 START -->
<!-- Metadata: {"Header 1": "Overview", "Header 2": "Observation Footprints"} -->
Astroview represents each observation in a Portal search results table as a wire-frame (or _**footprint**_) of the extent of an instrument aperture or detector, centered on the intended target or region. The footprints are superimposed on an image of the sky, as shown in Fig. 1 below.
![Search results, with footprints in AstroView](https://outerspace.stsci.edu/download/attachments/94962998/av_7023.png?version=1&modificationDate=1615210143706&api=v2)
**Figure 1 —** A results Table panel (_left_) for a Portal search on the star-forming region NGC7023, and the corresponding AstroView panel (_right_). Footprints of observations, represented as wireframes (_boxes in various colors_), correspond to instrument apertures; these are superimposed on a portion of the Digital Sky Survey. The Filters panel has been hidden for clarity. The wireframe of a selected observation in the table is highlighted (_white rectangle_) in AstroView.

<!-- CHUNK 3 END -->

<!-- CHUNK 4 START -->
<!-- Metadata: {"Header 1": "Overview", "Header 2": "Observation Footprints", "Header 3": "Footprint Selection"} -->
Which footprints are displayed in AstroView can be modified with the drop-down menu ![AstroView footprint controls](https://outerspace.stsci.edu/download/thumbnails/94962998/menu_footprints.png?version=1&modificationDate=1615210143718&api=v2) for which the choices are:
* None – do not show footprints
* All – show the footprints for all observations in a single search results table
* Selected – show footprints only for observations that are selected in the results table.  
Selecting one or more observations in the results table also highlights in white the corresponding wireframe(s). The color of the rest of the wireframes _in a single search_ can be specified with the color-picker drop-down menu.
![AstroView footprint color selector](https://outerspace.stsci.edu/download/thumbnails/94962998/menu_colorPicker.png?version=1&modificationDate=1615210143709&api=v2)
The results of all searches in a Portal session will be displayed in AstroView. The footprints of the results of each individual search may be represented in a separate color. This can be useful, for example, when planning future observations if the footprint of archived observations from different instruments or filters are represented different colors. In Fig. 1 the colors represent:
Red | Planned JWST images with MIRI and NIRCam in various IR bands
---|---
Yellow | Existing HST observations with NICMOS and with the WFC3/IR channel
Cyan | Existing HST observations with WFPC2 and ACS in various optical bands
White | Highlighted wireframe of the selected HST/WFC3 image

<!-- CHUNK 4 END -->

<!-- CHUNK 5 START -->
<!-- Metadata: {"Header 1": "Overview", "Header 2": "Background Survey"} -->
The sky background on which the footprints are superimposed is taken from a sky survey. The default of the Digital Sky Survey may be changed to another available survey in the following way:  
| Action | Result |  
---|---|---|---
1 | Click the gear icon (lower right of the panel) to bring up the _AstroView Settings_ menu. | ![](https://outerspace.stsci.edu/download/thumbnails/94962998/icon_gear.png?version=1&modificationDate=1615210143678&api=v2) |  
2 |  Select a background survey from one of the drop-down menus. The new background will load quickly, so you can browse the choices before closing. The surveys have different resolutions and depth, and few of them cover the full sky. The example at left shows NGC 2440 in the DSS and Pan-STARRS surveys. | ![AstroView settings menu](https://outerspace.stsci.edu/download/attachments/94962998/menu_AstroView_settings.png?version=1&modificationDate=1615210143687&api=v2) |  ![AstroView with DSS background](https://outerspace.stsci.edu/download/thumbnails/94962998/Screen%20Shot%202020-10-22%20at%201.50.37%20PM.png?version=1&modificationDate=1615210143713&api=v2) DSS ![AstroView with Pan-STARRS background](https://outerspace.stsci.edu/download/thumbnails/94962998/Screen%20Shot%202020-10-22%20at%201.54.13%20PM.png?version=1&modificationDate=1615210143716&api=v2) Pan-STARRS
3 | When finished, click the _**Close**_ button. |
|  
Sky survey coverage
Not all available sky surveys used with Astroview have all-sky coverage. For example, selecting SDSS for targets with extreme southern declination will result in a uniformly black background. All Astroview functions will continue to work.

<!-- CHUNK 5 END -->

<!-- CHUNK 6 START -->
<!-- Metadata: {"Header 1": "Overview", "Header 2": "Pan, Zoom, and Coordinates"} -->
To _**pan**_ the AstroView window to a different position, press mouse button-1 over the image, and drag to a new position. To adjust the _**zoom**_ level, either
* scroll with your mouse over the AstroView panel, or
* use the icons in the lower-left: ![Zoom-in button](https://outerspace.stsci.edu/download/thumbnails/94962998/Screen%20Shot%202020-10-20%20at%204.08.36%20PM.png?version=1&modificationDate=1615210143698&api=v2) or ![Zoom-out button](https://outerspace.stsci.edu/download/thumbnails/94962998/Screen%20Shot%202020-10-20%20at%204.09.13%20PM.png?version=1&modificationDate=1615210143701&api=v2).  
Coordinates are by default shown at the upper-right of the image.
* The upper coordinates (in orange) show the coordinates of the position of your cursor in the image.
* The lower coordinates (in purple) correspond to the last selected position in the image (probably the center of one of the observation footprints).  
Click the ![Toggle for displaying coordinates as decimal or sexagesimal](https://outerspace.stsci.edu/download/thumbnails/94962998/button_RaDec.png?version=1&modificationDate=1615210143703&api=v2) button to change the coordinates from sexagesimal to degrees and back.

<!-- CHUNK 6 END -->

<!-- CHUNK 7 START -->
<!-- Metadata: {"Header 1": "For Further Reading..."} -->
* [Data Browsing Tools](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94962980/Data+Browsing+Tools)  
