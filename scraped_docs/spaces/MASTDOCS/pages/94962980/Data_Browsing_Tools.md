---
title: "MAST Document"
source_url: "https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94962980/Data+Browsing+Tools"
date_accessed: "2026-03-11T11:32:30.250889"
---

<!-- CHUNK 1 START -->
**On this page...**
* 1[Cutout Tool](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94962980/Data+Browsing+Tools#DataBrowsingTools-CutoutToolCutoutTool)
* 1.1[Image Overlay ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94962980/Data+Browsing+Tools#DataBrowsingTools-ImageOverlay)
* 2[Spectral Viewer ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94962980/Data+Browsing+Tools#DataBrowsingTools-SpectralViewerSpectralViewer)
* 3[Lcviz: Timeseries Viewer ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94962980/Data+Browsing+Tools#DataBrowsingTools-TimeseriesViewerLcviz:TimeseriesViewer)
* 4[Cross-Match Tool ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94962980/Data+Browsing+Tools#DataBrowsingTools-CrossmatchToolCross-MatchTool)
* 5[Charting Tool ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94962980/Data+Browsing+Tools#DataBrowsingTools-Chart_ToolChartingTool)  
There are a variety of tools available for interacting with the results of a search. The most prominent tool in the search results window is the **AstroView** Tool, which shows the footprint(s) of entries in the results grid superimposed on a sky background (by default, the Digital Sky Survey). [AstroView](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94962998/AstroView) is described separately.
...
---|---|---
![](https://outerspace.stsci.edu/download/thumbnails/94962980/Screenshot%202024-09-30%20at%2007.39.53.png?version=1&modificationDate=1727696422987&api=v2) | [Lcviz Viewer](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94962980/Data+Browsing+Tools#DataBrowsingTools-TimeseriesViewer) | View the data using the
![Invoke spectral viewer](https://outerspace.stsci.edu/download/thumbnails/94962980/portal_result_action_spectrum.png?version=1&modificationDate=1699892033911&api=v2) | [Spectral Viewer](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94962980/Data+Browsing+Tools#DataBrowsingTools-SpectralViewer) | View the data in the Spectrum Visualization tool
![](https://outerspace.stsci.edu/download/thumbnails/94962980/jdaviz_icon.png?version=1&modificationDate=1699892033683&api=v2)
| [Jdaviz](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/150113039/Jdaviz+Guide) | View the data in the Jdaviz tool
![Image overlay toggle](https://outerspace.stsci.edu/download/thumbnails/94962980/portal_result_action_overlay.png?version=1&modificationDate=1699892033952&api=v2) | Toggle Overlay Image | Toggle an image overlay in AstroView
...
View | Icon
---|---
List View | ![](https://outerspace.stsci.edu/download/thumbnails/94962980/cutout_list.png?version=1&modificationDate=1699892033773&api=v2)
Album View | ![](https://outerspace.stsci.edu/download/thumbnails/94962980/cutout_album.png?version=1&modificationDate=1699892033813&api=v2)
Checking the box will show a new _**Cutout**_ column which displays cutout images for all search results where available (Figure 1). Results that have no cutouts available will display "No Cutout Available".  
![Search Results List with an example query and the 'show cutout' option checked. This displays available FITS cutouts](https://outerspace.stsci.edu/download/attachments/94962980/list_view_previews_cutouts.png?version=1&modificationDate=1699892033720&api=v2)
...
![Search results with Album View](https://outerspace.stsci.edu/download/attachments/94962980/cutout_album_view.jpg?version=1&modificationDate=1699892034301&api=v2)Search results with Album View![Search results with Album View and cutout size control](https://outerspace.stsci.edu/download/attachments/94962980/cutout_album_resolution.png?version=1&modificationDate=1699892034290&api=v2)
...
<!-- CHUNK 2 START -->
<!-- Metadata: {"Header 2": "Image Overlay ![](https://outerspace.stsci.edu/download/attachments/94962980/portal_result_action_overlay.png?version=1&modificationDate=1699892033952&api=v2)"} -->
...
![Overlaying an Image](https://mast.stsci.edu/portal_jwst/Mashup/Clients/Mast/data/images/imageoverlays.png)
...
<!-- CHUNK 3 START -->
<!-- Metadata: {"Header 1": "![](https://outerspace.stsci.edu/download/thumbnails/94962980/portal_result_action_spectrum.png?version=1&modificationDate=1699892033911&api=v2)"} -->
The Spectral Viewer action button indicates that the relevant observation has a spectrum that can be viewed with the Spectrum Plotter tool. Clicking this button opens up a new window (Fig. 4), displaying the spectrum for the given row. To select and overplot multiple spectra (up to 10), select all valid rows of interest you wish to view, and click the Spectrum Viewer icon that is located in the [Search Results Toolbar](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94962944/Search+Results+Grid). This opens up the same window with all selected spectra over-plotted.  
![Spectral Viewer window](https://outerspace.stsci.edu/download/attachments/94962980/window_specViewer.png?version=1&modificationDate=1699892034595&api=v2)
**Figure 4** **—** the Spectrum Viewer tool. **Configuration Panel**(_left_): Options for configuring the spectrum display, adding markers or spectral lines, or performing spectral line fitting. **Spectrum Panel** (_middle_): Displays any loaded spectrum as flux vs wavelength. **Legend Panel**(_right_): Contains all spectra loaded into the tool, as well as any additional markers, as toggle-able display elements.
...
Section | Description
---|---
Range | Change the x-axis or y-axis display range or scaling
Options | Change plot grid and line styles, or smooth the spectrum
Indicators | Add a vertical line at a specified wavelength
Line Lists | Add a marker for a specified spectral line
Fitting | Perform simple spectral line fitting
Doppler Shift | Shift the spectrum by a specified redshift or velocity value

<!-- CHUNK 3 END -->

<!-- CHUNK 4 START -->
<!-- Metadata: {"Header 1": "![](https://outerspace.stsci.edu/download/thumbnails/94962980/Screenshot%202024-09-30%20at%2007.39.53.png?version=1&modificationDate=1727696422987&api=v2)"} -->
The Lcviz has an option to phase fold the data to discover periodic events such as transiting exoplanets. You can accept the default phase folding (the period of the highest peak in the periodogram), or input your own ephemeris information.  
![](https://outerspace.stsci.edu/download/attachments/94962980/lcviz3.png?version=1&modificationDate=1727696703406&api=v2)  
**Figure 5** **—** Lcviz tool. **Timeseries Plot** (_left_): Timeseries data, displayed in a plot as flux vs time. **Folded Curve** (_middle_): Lcviz includes a tool that allows you to create phase-folded light curves. Here, the curve has been folded based on the periodogram; the highest power peak was selected as the period. **Plugin Sidebar** (_right_): The sidebar contains options to display metadata, select the desired flux column,
The Configuration Panel has the following sections:
Section | Description
---|---
Range | Change the x-axis or y-axis display range or scaling
Options | Change plot grid and line styles, or smooth the spectrum
Phase Folding | Phase fold the time series spectrum by a specified period

<!-- CHUNK 4 END -->

<!-- CHUNK 5 START -->
<!-- Metadata: {"Header 1": "![](https://mast.stsci.edu/portal_jwst/Mashup/Clients/Shared/img/crossmatch_24.png)"} -->
To cross-match a set of search results against other MAST or CDS catalogs, click the Cross-Match button, located in the [Search Results Toolbar](https://innerspace.stsci.edu/display/MD/Search+Results+Grid#SearchResultsGrid-ResultsToolbar), to display a pop-up window (**Figure 6**). Select the catalog resource against which to match, specify the match radius in arcseconds, choose whether to match against all rows or a selected subset, and click the cross-match button to begin the search. The returned results will display as a new tab in the main Search Results Grid. The new tab will display all columns from the original search plus all columns from the matched catalog. To perform a successful cross-match, the original search results must contain proper RA and Dec coordinate columns. If no results are found, or an error occurred during cross-match, a pop-up message will be displayed indicating the reason, and no new tab will be created.  
![Cross-match tool selection dialog](https://outerspace.stsci.edu/download/attachments/94962980/menu_crossMatch.png?version=1&modificationDate=1699892034605&api=v2)
...
<!-- CHUNK 6 START -->
<!-- Metadata: {"Header 1": "![](https://mast.stsci.edu/portal_jwst/Mashup/Clients/Shared/img/charts-24x24.png)"} -->
To explore scatter plot relationships between columns in a set of search results, click the **Charting Tool** button, located in the [Search Results Toolbar](https://innerspace.stsci.edu/display/MD/Search+Results+Grid#SearchResultsGrid-ResultsToolbar), to display a pop-up window (**Figure 7**). The plotter tool lets you plot any two numeric columns against each other for display as a scatter plot. Columns can also be combined by selecting the [Combine Columns](https://innerspace.stsci.edu/display/MD/Search+Results+Grid#SearchResultsGrid-CreateNewColumns) button, which allows for arithmetic between two columns. Each axis can be configured by adjusting the range sliders or manually specifying new axis bounds. The plot image will automatically adjust. Click "Reset Range" to reset the axis ranges to their defaults. The user may also click-and-drag in the plot window to zoom in on a region, which also updates the axis ranges automatically. Data subsets may be selected by holding Shift while click-and-dragging. The selected subsets will update the results displayed in the Results Grid.  
![Chart tool window](https://outerspace.stsci.edu/download/attachments/94962980/portal_plotter.png?version=1&modificationDate=1699892034587&api=v2)
**Figure 7** **—** the Plotter tool. **Configuration Panel** (_left_): Options for configuring the plot axes and display columns. **Plot Panel** (_right_): Displays the selected data.
The Configuration Panel has the following sections:
Section | Description
---|---
Series | Change the selected columns to plot
Range | Change the x-axis or y-axis display range or scaling
...
<!-- CHUNK 7 START -->
<!-- Metadata: {"Header 1": "![](https://mast.stsci.edu/portal_jwst/Mashup/Clients/Shared/img/charts-24x24.png)", "Header 2": "Image Overlay ![](https://outerspace.stsci.edu/download/attachments/94962980/portal_result_action_overlay.png?version=1&modificationDate=1699892033952&api=v2)"} -->
The Image Overlay action button indicates that the image of the relevant observation can be overlaid on the AstroView on-sky panel; see Figure 3.  
![Overlaying an Image](https://mast.stsci.edu/portal_jwst/Mashup/Clients/Mast/data/images/imageoverlays.png)
**Figure 3** **—** the Image Overlay action. Clicking the "Image Overlay" action button overlays the image cutout in the AstroView tool, with the proper WCS coordinate matching.
