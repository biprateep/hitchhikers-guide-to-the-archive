---
title: "MAST Document"
source_url: "https://outerspace.stsci.edu/spaces/MASTDOCS/pages/217350629/JWST+Search+Components"
date_accessed: "2026-03-11T11:37:16.683427"
---

<!-- CHUNK 1 START -->
**On this page...**
* 1[JWST-Specific Search Components](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/217350629/JWST+Search+Components#JWSTSearchComponents-comp_datatypeJWST-SpecificSearchComponents)
* 1.1[Dataset ID](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/217350629/JWST+Search+Components#JWSTSearchComponents-DatasetID)
* 1.3[Data Type](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/217350629/JWST+Search+Components#JWSTSearchComponents-DataType)
* 1.4[Instrument Selector](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/217350629/JWST+Search+Components#JWSTSearchComponents-InstrumentSelector)
* 1.5[Moving Target Flag](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/217350629/JWST+Search+Components#JWSTSearchComponents-MovingTargetFlag)
* 1.6[Observation Mode](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/217350629/JWST+Search+Components#JWSTSearchComponents-ObservationMode)
* 1.7[Observation and visit Numbers](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/217350629/JWST+Search+Components#JWSTSearchComponents-ObservationandvisitNumbers)
* 1.8[Proposal Cycle](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/217350629/JWST+Search+Components#JWSTSearchComponents-ProposalCycle)
* 1.9[Proposal Type](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/217350629/JWST+Search+Components#JWSTSearchComponents-ProposalType)
* 2[For Further Reading...](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/217350629/JWST+Search+Components#JWSTSearchComponents-ForFurtherReading...)

<!-- CHUNK 1 END -->

<!-- CHUNK 2 START -->
<!-- Metadata: {"Header 1": "JWST-Specific Search Components"} -->
...
Do not attempt to check for duplicate observations using the new JWST search form; planned but unexecuted observations will not be included. You should either use the [MAST Portal](https://mast.stsci.edu) or follow the instructions in the

<!-- CHUNK 2 END -->

<!-- CHUNK 3 START -->
<!-- Metadata: {"Header 1": "JWST-Specific Search Components", "Header 2": "Dataset ID"} -->
![](https://outerspace.stsci.edu/download/thumbnails/217350629/jwst-dataset-id.png?version=1&modificationDate=1698759267918&api=v2)
A **Dataset ID** marks a "top-level" collection of files from an Observation. The naming convention follows a truncated version of the full
* * *

<!-- CHUNK 3 END -->

<!-- CHUNK 4 START -->
<!-- Metadata: {"Header 1": "JWST-Specific Search Components", "Header 2": "Data Type"} -->
![](https://outerspace.stsci.edu/download/attachments/217350629/jwst-data-types.png?version=1&modificationDate=1698759267687&api=v2)
The **Data Type** refers to the semantic content of the highest-level [pipeline product](https://jwst-docs.stsci.edu/accessing-jwst-data/jwst-science-data-overview) for the type of exposure that produced the data. Note that slitless and IFU spectral modes ultimately produce data of type _Spectrum_.
_Other_ data includes internal calibration and guide-star data.
* * *

<!-- CHUNK 4 END -->

<!-- CHUNK 5 START -->
<!-- Metadata: {"Header 1": "JWST-Specific Search Components", "Header 2": "Instrument Selector"} -->
![](https://outerspace.stsci.edu/download/attachments/217350629/jw-inst-select.png?version=1&modificationDate=1698759267748&api=v2)
By default, all **Instruments** are selected. The upper right of the field presents a _Select all_ vs.  _Deselect all_ choice. You can also select individual fields.
* * *

<!-- CHUNK 5 END -->

<!-- CHUNK 6 START -->
<!-- Metadata: {"Header 1": "JWST-Specific Search Components", "Header 2": "Moving Target Flag"} -->
![](https://outerspace.stsci.edu/download/thumbnails/217350629/jwst-mt.png?version=1&modificationDate=1698759267774&api=v2)
Enabling the **Moving Targets** flag will only return targets without fixed coordinates (i.e. solar system targets).
* * *

<!-- CHUNK 6 END -->

<!-- CHUNK 7 START -->
<!-- Metadata: {"Header 1": "JWST-Specific Search Components", "Header 2": "Observation Mode"} -->
![](https://outerspace.stsci.edu/download/thumbnails/217350629/jwst-obs-mode.png?version=1&modificationDate=1698759267948&api=v2)
The **Observation Mode** selector is empty by default. Note that searching for "all" and "none" are equivalent, as all observing modes will be included in both cases. This mode does not include type-ahead, so you must select your choice from the drop-down menu.
* * *

<!-- CHUNK 7 END -->

<!-- CHUNK 8 START -->
<!-- Metadata: {"Header 1": "JWST-Specific Search Components", "Header 2": "Observation and visit Numbers"} -->
![](https://outerspace.stsci.edu/download/attachments/217350629/jwst-obsnum.png?version=1&modificationDate=1698759267890&api=v2)
![](https://outerspace.stsci.edu/download/attachments/217350629/jwst-visitnum.png?version=1&modificationDate=1698759267865&api=v2)
The **Observation Number** and **Visit Number** correspond to planning information from the submitted [APT file](https://www.stsci.edu/scientific-community/software/astronomers-proposal-tool-apt). You can find the APT file, as well as a PDF summary, by searching for the corresponding proposal on the [JWST Program Information search form](https://www.stsci.edu/jwst/science-execution/program-information).
* * *

<!-- CHUNK 8 END -->

<!-- CHUNK 9 START -->
<!-- Metadata: {"Header 1": "JWST-Specific Search Components", "Header 2": "Proposal Cycle"} -->
![](https://outerspace.stsci.edu/download/thumbnails/217350629/jwst-prop-cycle.png?version=1&modificationDate=1698759267806&api=v2)  
**Proposal Cycle** is the number of the JWST Proposal Cycle in which the program was submitted and approved. This does not necessarily correspond to the epoch of the [scheduled observation](https://www.stsci.edu/jwst/science-execution/observing-schedules).
* * *

<!-- CHUNK 9 END -->

<!-- CHUNK 10 START -->
<!-- Metadata: {"Header 1": "JWST-Specific Search Components", "Header 2": "Proposal Type"} -->
![](https://outerspace.stsci.edu/download/thumbnails/217350629/jwst-prop-type.png?version=1&modificationDate=1698759267835&api=v2)
**Proposal Type** is the programmatic category assigned to the proposal. There are several [Categories of JWST Science Observations](https://www.stsci.edu/jwst/science-execution/approved-programs).
* * *
