---
title: "MAST Document"
source_url: "https://outerspace.stsci.edu/spaces/MASTDOCS/pages/150113139/Redshift"
date_accessed: "2026-03-11T16:26:57.451492"
content_length: 20107
---

<!-- CHUNK 1 START -->
On this page...
* 1[Summary](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/150113139/Redshift#Redshift-Summary)
* 2[Setup and Background](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/150113139/Redshift#Redshift-SetupandBackground)
* 3[Video Tutorial](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/150113139/Redshift#Redshift-VideoTutorial)
* 4[For Further Reading...](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/150113139/Redshift#Redshift-ForFurtherReading...)

<!-- CHUNK 1 END -->

<!-- CHUNK 2 START -->
<!-- Metadata: {"Header 1": "Summary"} -->
This tutorial will show you how to quickly estimate the redshift of a target. To do this, we will take advantage of several convenient features that are available in Jdaviz; namely, data modeling, built-in spectral line lists, and a redshift slider. We'll cover these features in more detail in the sections below.
...
<!-- CHUNK 3 START -->
<!-- Metadata: {"Header 1": "Setup and Background"} -->
This tutorial does not require the installation of any additional software. You can follow [this link](https://mast.stsci.edu/viz/ui/#/spectra?filename=jw01039-o005_t001_miri_ch3-shortlongmedium-_x1d.fits) to the Jdaviz analysis tool with the data pre-loaded. The data is also available in MAST, under the observation ID "jw01039-o005_t001_miri_ch3-shortlongmedium_". Be sure to use the Channel 3 combined data.
...
<!-- CHUNK 4 START -->
<!-- Metadata: {"Header 1": "Video Tutorial"} -->
...
* [Redshift via Line Identification](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/150113139/Redshift "Redshift via Line Identification")
