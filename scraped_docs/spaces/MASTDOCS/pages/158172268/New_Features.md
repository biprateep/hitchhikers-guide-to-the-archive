---
title: "MAST Document"
source_url: "https://outerspace.stsci.edu/spaces/MASTDOCS/pages/158172268/New+Features"
date_accessed: "2026-03-11T16:27:02.327195"
content_length: 17131
---

<!-- CHUNK 1 START -->
This page highlights some of the new features that are available in the [updated Hubble Search](https://mast.stsci.edu/search/ui/#/hst).
**On this page...**
* 1[Autocomplete Suggestions](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/158172268/New+Features#NewFeatures-AutocompleteSuggestions)
* 2[Show API Query](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/158172268/New+Features#NewFeatures-ShowAPIQuery)
* 3[For Further Reading...](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/158172268/New+Features#NewFeatures-ForFurtherReading...)

<!-- CHUNK 1 END -->

<!-- CHUNK 2 START -->
<!-- Metadata: {"Header 1": "Autocomplete Suggestions"} -->
...
![](https://outerspace.stsci.edu/download/attachments/158172268/PI_typeahead.png?version=1&modificationDate=1662673349400&api=v2)![](https://outerspace.stsci.edu/download/attachments/158172268/filter_typeahead.png?version=1&modificationDate=1662673349387&api=v2)  
...
<!-- CHUNK 3 START -->
<!-- Metadata: {"Header 1": "Show API Query"} -->
...
![The three buttons at the bottom of the search page. The rightmost button is the 'Show API Query' button.](https://outerspace.stsci.edu/download/attachments/158172268/show_api_query.png?version=1&modificationDate=1662673349374&api=v2)Show API Query
...
![](https://outerspace.stsci.edu/download/attachments/158172268/api_query_form.png?version=1&modificationDate=1662673349358&api=v2)  
**Figure 2** : An API query, specifically a curl script, which was generated using the example found on the [Basic Search](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/158172246/HST+Basic+Search) page.
