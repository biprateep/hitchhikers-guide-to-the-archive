---
title: "MAST Document"
source_url: "https://outerspace.stsci.edu/spaces/MASTDOCS/pages/131859421/Minimum+Recommended+Products"
date_accessed: "2026-03-11T11:36:30.315830"
---

<!-- CHUNK 1 START -->
**On this page...**
* 1[Recommended Data Products](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/131859421/Minimum+Recommended+Products#MinimumRecommendedProducts-RecommendedDataProducts)
* 1.1[MRP in the Portal](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/131859421/Minimum+Recommended+Products#MinimumRecommendedProducts-MRPinthePortal)
* 2[For Further Reading...](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/131859421/Minimum+Recommended+Products#MinimumRecommendedProducts-ForFurtherReading...)

<!-- CHUNK 1 END -->

<!-- CHUNK 2 START -->
<!-- Metadata: {"Header 1": "Recommended Data Products"} -->
Of the many different data products produced by the science calibration pipeline, a subset has been identified as essential for extracting the intended science from the data, or for users who wish to recalibrate lower-level products with the _minimum recommended_ _products_ (MRP). The selection of data products that are included in this set depends upon the instrument used to obtain the data, its configuration and operating mode, and the level to which the observations have been calibrated. Generally, products in the MRP include the most calibrated science product (i.e., those for which the instrumental signature has been removed) along with the associated data products.
Products _**not**_ included in the MRP set supplement science investigations, or help users assess the quality of the science data products. Depending on the Mission, such products might include:
...
<!-- CHUNK 3 START -->
<!-- Metadata: {"Header 1": "Recommended Data Products", "Header 2": "MRP in the Portal"} -->
![](https://outerspace.stsci.edu/download/thumbnails/131859421/filter_MRP.png?version=1&modificationDate=1646097403121&api=v2)

<!-- CHUNK 3 END -->

<!-- CHUNK 4 START -->
<!-- Metadata: {"Header 1": "Recommended Data Products", "Header 2": "MRP in the Portal", "Header 3": "Data Product Category"} -->
Minimum Recommended products may be selected in the [Download Manager](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963019/Download+Basket) with a Filter checkbox. Choosing MRP will:
