---
title: "MAST Document"
source_url: "https://outerspace.stsci.edu/spaces/MASTDOCS/pages/382632830/Supported+Products"
date_accessed: "2026-03-11T11:35:28.465074"
---

<!-- CHUNK 1 START -->
**On this page...**
* 1[Known Supported Products](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/382632830/Supported+Products#SupportedProducts-KnownSupportedProducts)
* 2[Examples in MAST-Jdaviz](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/382632830/Supported+Products#SupportedProducts-ExamplesinMAST-Jdaviz)
* 2.1[HST Images](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/382632830/Supported+Products#SupportedProducts-HSTImages)
* 2.2[HST spectra](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/382632830/Supported+Products#SupportedProducts-HSTspectra)
* 2.3[TESS lightcurves](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/382632830/Supported+Products#SupportedProducts-TESSlightcurves)
* 3[For Further Reading...](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/382632830/Supported+Products#SupportedProducts-ForFurtherReading...)

<!-- CHUNK 1 END -->

<!-- CHUNK 2 START -->
<!-- Metadata: {"Header 1": "Known Supported Products"} -->
Jdaviz generally supports loading any kind of image or spectral data products by filename, MAST URI, numpy array object, or specutils.Spectrum object. Jdaviz attempts to identify and load spectral data using the
Collection | Data Products
---|---
JWST | i2d, x1d, c1d, s2d, s3d
HST | drz, sx1, sx2
SDSS |  manga: LOGCUBE apogee: apStar, apVisit, aspcapStar eboss: spec-full, spec-lite
TESS | lc
Kepler | llc, slc
K2 | llc, slc
...
<!-- CHUNK 3 START -->
<!-- Metadata: {"Header 1": "Examples in MAST-Jdaviz"} -->
Below are examples of other data products loaded into MAST-Jdaviz

<!-- CHUNK 3 END -->

<!-- CHUNK 4 START -->
<!-- Metadata: {"Header 1": "Examples in MAST-Jdaviz", "Header 2": "HST Images"} -->
![](https://outerspace.stsci.edu/download/attachments/382632830/mast_hst_product.png?version=1&modificationDate=1742327130254&api=v2)![](https://outerspace.stsci.edu/download/attachments/382632830/mast_hst_imviz.png?version=1&modificationDate=1742327127931&api=v2)
**Figure 1** - HST image product loaded into MAST-Jdaviz's Imviz

<!-- CHUNK 4 END -->

<!-- CHUNK 5 START -->
<!-- Metadata: {"Header 1": "Examples in MAST-Jdaviz", "Header 2": "HST spectra"} -->
![](https://outerspace.stsci.edu/download/attachments/382632830/mast_hst_sx1_product.png?version=1&modificationDate=1742327231065&api=v2)![](https://outerspace.stsci.edu/download/attachments/382632830/mast_hst_sx1.png?version=1&modificationDate=1742327231251&api=v2)
**Figure 2** - HST 1d spectral product loaded into MAST-Jdaviz's Specviz

<!-- CHUNK 5 END -->

<!-- CHUNK 6 START -->
<!-- Metadata: {"Header 1": "Examples in MAST-Jdaviz", "Header 2": "TESS lightcurves"} -->
![](https://outerspace.stsci.edu/download/attachments/382632830/mast_tess_product.png?version=1&modificationDate=1742327132449&api=v2)![](https://outerspace.stsci.edu/download/attachments/382632830/mast_tess_lcviz.png?version=1&modificationDate=1742327131544&api=v2)
**Figure 3** - TESS lightcurve product loading to MAST-Jdaviz's LCviz
