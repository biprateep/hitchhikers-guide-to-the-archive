---
title: "MAST Document"
source_url: "https://outerspace.stsci.edu/spaces/MASTDOCS/pages/158174811/ULLYSES+Search+Components"
date_accessed: "2026-03-11T11:37:11.112293"
---

<!-- CHUNK 1 START -->
**On this page...**
* 1[Component Overview](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/158174811/ULLYSES+Search+Components#ULLYSESSearchComponents-ComponentOverview)
* 1.1[ Parameter Constraint Syntax](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/158174811/ULLYSES+Search+Components#ULLYSESSearchComponents-param_constraintsParameterConstraintSyntax)
* 1.2[ULLYSES Search Parameter Components](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/158174811/ULLYSES+Search+Components#ULLYSESSearchComponents-ULLYSESSearchParameterComponents)
* 1.2.1[Telescope](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/158174811/ULLYSES+Search+Components#ULLYSESSearchComponents-Telescope)
* 1.2.2[HST Instruments](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/158174811/ULLYSES+Search+Components#ULLYSESSearchComponents-HSTInstruments)
* 1.2.3[Target Type](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/158174811/ULLYSES+Search+Components#ULLYSESSearchComponents-TargetType)
* 1.2.4[HLSP Type](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/158174811/ULLYSES+Search+Components#ULLYSESSearchComponents-HLSPType)
* 1.2.5[Spectral Band](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/158174811/ULLYSES+Search+Components#ULLYSESSearchComponents-SpectralBand)
* 2[For Further Reading...](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/158174811/ULLYSES+Search+Components#ULLYSESSearchComponents-ForFurtherReading...)

<!-- CHUNK 1 END -->

<!-- CHUNK 2 START -->
<!-- Metadata: {"Header 1": "Component Overview"} -->
The **'****ULLYSES Search Parameter Components'** section contains the search parameters for the ULLYSES HLSP data collection. This page overviews the types of search components and how to specify parameter constraints.
Filtering data will return targets that include the selected criteria but are not limited to those criteria. For example, filtering by 'Telescope=FUSE' will return targets that include FUSE data _and_ data from other telescopes.
Learn how to specify constraints on search parameters depending on the nature of the input. The following specifications apply for the core search parameters and [Additional Search Parameters](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958265/Additional+Search+Parameters) in the search form.
Hovering over each filter box shows tooltips on how to use search conditions.

<!-- CHUNK 2 END -->

<!-- CHUNK 3 START -->
<!-- Metadata: {"Header 1": "Component Overview", "Header 2": "ULLYSES Search Parameter Components", "Header 3": "Telescope"} -->
![](https://outerspace.stsci.edu/download/attachments/158174811/ullyses_telescope.png?version=1&modificationDate=1664284589856&api=v2)
By default, all **'Telescope'** options are selected. Toggle the checkboxes to select and/or deselect the Telescope selections.

<!-- CHUNK 3 END -->

<!-- CHUNK 4 START -->
<!-- Metadata: {"Header 1": "Component Overview", "Header 2": "ULLYSES Search Parameter Components", "Header 3": "HST Instruments"} -->
![](https://outerspace.stsci.edu/download/attachments/158174811/ullyses_hst_instruments.png?version=1&modificationDate=1664284593693&api=v2)
By default, all **'HST Instrument'** options are selected. Toggle the checkboxes to select and/or deselect the Telescope selections.
**Note:** If HST is deselected in the Telescope component, the options for this component will be disabled and not included in the filter.

<!-- CHUNK 4 END -->

<!-- CHUNK 5 START -->
<!-- Metadata: {"Header 1": "Component Overview", "Header 2": "ULLYSES Search Parameter Components", "Header 3": "Target Type"} -->
![](https://outerspace.stsci.edu/download/attachments/158174811/ullyses_target_type.png?version=1&modificationDate=1664284593715&api=v2)
By default, all **'Target Type'** options are selected. Toggle the check boxes to select and/or deselect the Target Type selections.

<!-- CHUNK 5 END -->

<!-- CHUNK 6 START -->
<!-- Metadata: {"Header 1": "Component Overview", "Header 2": "ULLYSES Search Parameter Components", "Header 3": "HLSP Type"} -->
![](https://outerspace.stsci.edu/download/attachments/158174811/ullyses_hlsp_type.png?version=1&modificationDate=1664284593739&api=v2)
By default, all **'HLSP Type'** options are selected. Toggle the checkboxes to select and/or deselect the HLSP Type selections.

<!-- CHUNK 6 END -->

<!-- CHUNK 7 START -->
<!-- Metadata: {"Header 1": "Component Overview", "Header 2": "ULLYSES Search Parameter Components", "Header 3": "Spectral Band"} -->
![](https://outerspace.stsci.edu/download/attachments/158174811/ullyses_spectral_band.png?version=1&modificationDate=1664284589879&api=v2)
By default, all **'Wavelength'** options are selected. Toggle the checkboxes to select and/or deselect the Wavelength selections.
