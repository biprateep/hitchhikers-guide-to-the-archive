---
title: "MAST Document"
source_url: "https://outerspace.stsci.edu/spaces/MASTDOCS/pages/97290405/File+Types+Formats+and+Content"
date_accessed: "2026-03-11T11:34:40.473061"
---

<!-- CHUNK 1 START -->
**On this page...**
* 1[Accepted File and Content Types](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/97290405/File+Types+Formats+and+Content#FileTypes,Formats,andContent-AcceptedFileandContentTypes)
* 1.1[Science Products](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/97290405/File+Types+Formats+and+Content#FileTypes,Formats,andContent-ScienceProducts)
* 1.2[Ancillary Products](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/97290405/File+Types+Formats+and+Content#FileTypes,Formats,andContent-AncillaryProducts)
* 2[Non-Accepted File and Content Types](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/97290405/File+Types+Formats+and+Content#FileTypes,Formats,andContent-Non-AcceptedFileandContentTypes)
* 2.1[Proprietary Formats and Certain Content Types](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/97290405/File+Types+Formats+and+Content#FileTypes,Formats,andContent-ProprietaryFormatsandCertainContentTypes)
* 2.2[Software](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/97290405/File+Types+Formats+and+Content#FileTypes,Formats,andContent-Software)
* 2.3[Certain FITS File Organization](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/97290405/File+Types+Formats+and+Content#FileTypes,Formats,andContent-CertainFITSFileOrganization)
* 3[For Further Reading...](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/97290405/File+Types+Formats+and+Content#FileTypes,Formats,andContent-ForFurtherReading...)

<!-- CHUNK 1 END -->

<!-- CHUNK 2 START -->
<!-- Metadata: {"Header 1": "Accepted File and Content Types"} -->
The types and formats of products that are accepted for HLSP collections are given in the following tables. Note that science products in

<!-- CHUNK 2 END -->

<!-- CHUNK 3 START -->
<!-- Metadata: {"Header 1": "Accepted File and Content Types", "Header 2": "Science Products"} -->
...
Catalog | FITS,  | BINTABLE (FITS), ASCII or DB dump, SQLite |  ECSV files should be parsable with common software. Database dumps from e.g.[required metadata](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/97290413/Catalog+Metadata).  CSV format is deprecated because it lacks formal support for metadata.
Light curve | FITS | BINTABLE | Time coordinate information may be represented in keywords or as an explicit table column.
Model or Simulation |
|
| Consult with MAST staff. Simulations of observational data would ordinarily be represented in the format appropriate for the product being simulated.

<!-- CHUNK 3 END -->

<!-- CHUNK 4 START -->
<!-- Metadata: {"Header 1": "Accepted File and Content Types", "Header 2": "Ancillary Products"} -->
Product | Formats | Data Organization | Notes
---|---|---|---
README | ASCII, HTML, | Single flat file, or file with markup; see [Example README](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/97290408/Example+HLSP+README) file, or a [simpler ASCII README](https://archive.stsci.edu/hlsps/tica/hlsp_tica_tess_ffi_all_tess_v01_readme.txt) file | Document that describes the collection contents. It must provide a description of the semantic content and organization of data in the files, and bibliographic information for the published paper(s) that describes the creation and use of the collection. Put details of the science goals, data processing methodology, etc. in the Project Summary file.
Manifest |  | Structured; see[MANIFEST.yml](https://outerspace.stsci.edu/download/attachments/97290405/MANIFEST.yml?version=1&modificationDate=1616683639424&api=v2) | Document that describes the product delivery manifest. It must provide the organization of data among the files. Details of the science goals, data processing methodology, etc. must be included in the Project Summary file.
Graphics | PDF, PostScript, gif, jpeg, png |
| Plots and illustrations to be used as previews for image, light curve, spectra, atlases, (possibly) catalogs. Also appropriate for elements of the project description.
Animation | MP4, WebM |
| Appropriate for some data product previews, particularly for models or simulations.
Project Summary | Outline-oriented structure: ASCII, HTML,  |
...
For _**all**_
* follow the[file naming convention](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/97290407/File+Naming+Convention).  
For _**science data**_
* include the required[metadata](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/97290409/Required+Metadata)

<!-- CHUNK 4 END -->

<!-- CHUNK 5 START -->
<!-- Metadata: {"Header 1": "Non-Accepted File and Content Types", "Header 2": "Proprietary Formats and Certain Content Types"} -->
Content that cannot be archived includes: publications, project tar files, or any files in a proprietary format (e.g., Microsoft Office).

<!-- CHUNK 5 END -->

<!-- CHUNK 6 START -->
<!-- Metadata: {"Header 1": "Non-Accepted File and Content Types", "Header 2": "Software"} -->
...
* Providing an analysis tool or Jupyter notebook that is tuned to the HLSP collection
* Providing back-end services that operate on the collection data  
MAST embraces the idea of associating software with data, but does not accept or support source code.
The staff at MAST encourage contributors to use third-party software repositories such as
**Please note:** links to a repository must point to a version of the resource (software, notebook, or documentation) that corresponds to the delivered version of the HLSP data products.
...
<!-- CHUNK 7 START -->
<!-- Metadata: {"Header 1": "Non-Accepted File and Content Types", "Header 2": "Certain FITS File Organization"} -->
...
* Table cells may contain simple 1-D arrays, however
...
* [File naming convention](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/97290407/File+Naming+Convention)
