---
title: "MAST Document"
source_url: "https://outerspace.stsci.edu/spaces/MASTDOCS/pages/150112931/JWST+Acronyms"
date_accessed: "2026-03-11T16:26:37.882663"
content_length: 20658
---

<!-- CHUNK 1 START -->
<!-- Metadata: {"Header 1": "Acronym Table"} -->
The following table contains many of the more common acronyms used in the context of JWST (and some related to HST or MAST). Use the search box to find specific acronyms, the originating organization, or text within the definitions.
Show 10 25 50 100 entries
Search:
Term | Organization | Meaning
---|---|---
4QPM | JWST | 4-Quadrant Phase Mask
ACS | JWST,Roman | Attitude Control System
ACS | HST | Advanced Camera for Surveys
AD | JWST | Activity Description
ADAPT | Roman |  Advanced Data Analytics Platform
ADC | HST, JWST | Analog-to-Digital Converter
ADQL | MAST | Astronomical Data Query Language
ADU | HST, JWST | Analog-to-Digital Unit
AMB | JWST | Anomaly Management Board
AMI | JWST | Aperture Mask Interferometry
AMI | MAST, Roman | Amazon Machine Image
AMU | JWST | Autonomous Momentum Unload
ANCO | JWST | Anomaly Coordinator
AOI | JWST,Roman | Archive Operator Interface
AOS | JWST | Acquisition of Signal
API | General | Application Programming Interface
APID | JWST | Application Process Identifier
APT | STScI | Astronomer's Proposal Tool
ARB | JWST | Anomaly Review Board
ART | JWST | Anomaly Review Team
ASDF | MAST, Roman | Advanced Scientific Data Format
ASIC | JWST | Application Specific Integrated Circuit
ATS | JWST | Automated Test Sequence
AUI | JWST | Archive User Interface
BATC | JWST | Ball Aerospace & Technologies Corporation
Showing 1 to 25 of 264 entries
...
* [JWST Acronyms and Abbreviations (JDox)](https://jwst-docs.stsci.edu/jwst-acronyms-and-abbreviations)  
