  * [Skip to main content](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages#title-heading)
  * [assistive.skiplink.to.breadcrumbs](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages#breadcrumbs)
  * [assistive.skiplink.to.header.menu](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages#rw_category_menu)
  * [assistive.skiplink.to.action.menu](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages#navigation)
  * [assistive.skiplink.to.quick.search](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages#rw_search_query)


  * [Skip to main content](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages#main "Skip to main content \(Type 'u' then '8'\)")
  * [Skip to breadcrumbs](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages#breadcrumbs)
  * [Skip to search](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages#quick-search-query)


  * [ Log in ](https://outerspace.stsci.edu/login.action?os_destination=%2Fspaces%2FMASTDOCS%2Fpages%2F113771324%2FData%2BProduct%2BLinkages "Login")
  * [ Help / Tips Help ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages "Help")
    * [ Online Help ](https://docs.atlassian.com/confluence/docs-95/ "Visit the Confluence documentation home")
    * [ Keyboard Shortcuts ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages "View available keyboard shortcuts \(Type '?'\)")
  ...
  * [](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
    * [Forums](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages "Forums")
...
[ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages "Open page in fullscreen \( Type 'F', shift + f \)")
  * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
    * [ Remove Read Confirmation  ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
    * [ A _t_ tachments (0)  ](https://outerspace.stsci.edu/pages/viewpageattachments.action?pageId=113771324 "View Attachments \(Type 't'\)")
    * [ Page History  ](https://outerspace.stsci.edu/pages/viewpreviousversions.action?pageId=113771324)
    * [ Page Information  ](https://outerspace.stsci.edu/pages/viewinfo.action?pageId=113771324)
    * [ Resolved comments  ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
    * [ View in Hierarchy  ](https://outerspace.stsci.edu/pages/listpages-dirview.action?key=MASTDOCS&openId=113771324#selectedPageInHierarchy)
    * [ View Source  ](https://outerspace.stsci.edu/plugins/viewsource/viewpagesrc.action?pageId=113771324)
    * [ Export to PDF  ](https://outerspace.stsci.edu/spaces/flyingpdf/pdfpageexport.action?pageId=113771324&atl_token=4fbee8de6962bdf33ba8100d353732d7750a69e9)
    * [ Export to Word  ](https://outerspace.stsci.edu/exportword?pageId=113771324)
    * [ Page Labels  ](https://outerspace.stsci.edu/plugins/userlabeltool/pagebulklabeloperations.action?pageId=113771324)
    * [ Attachment Labels  ](https://outerspace.stsci.edu/plugins/userlabeltool/pagebulkattachmentoperations.action?pageId=113771324)
    * [ Hide Inline Comments  ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/$generalUtil.getIdBasedPageUrl\($page\))
...
[Skip to end of banner](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages#page-banner-end)
  * [](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
  * [Jira links](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
  * [Workflow](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
  * [](https://outerspace.stsci.edu/spaces/viewtrackerreport.action?key=MASTDOCS)
  * [Read Confirmation](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)


[Go to start of banner](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages#page-banner-start)
#  [Data Product Linkages](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
  * Created by  ![User icon: shaw](https://outerspace.stsci.edu/s/aneund/9204/1jtwilc/_/images/icons/profilepics/anonymous.svg) [Richard A. Shaw](https://outerspace.stsci.edu/display/~shaw%0A), last updated on [May 08, 2024](https://outerspace.stsci.edu/pages/diffpagesbyversion.action?pageId=113771324&selectedPageVersions=63&selectedPageVersions=64 "Show changes") 4 minute read 
...
# Relationships Among Data Products
...
## Associations
The term [association](https://jwst-pipeline.readthedocs.io/en/stable/jwst/associations/index.html) is used within the JWST data management system to describe formally the connections among data that are essential in order to produce the highest-level products. See [JWST Data Associations](https://jwst-docs.stsci.edu/accessing-jwst-data/jwst-science-data-overview#JWSTScienceDataOverview-assocAssociations) for more information. Here are informal descriptions of the types of relationships that are included in associations:
### Prerequisite
...
# For Further Reading...
  ...
  * Pipeline definition of [Associations](https://jwst-pipeline.readthedocs.io/en/latest/jwst/associations/index.html)
...
null
  ...
  7. [Data Product Linkages](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)


You are not logged in. Any changes you make will be marked as anonymous. You may want to [Log In](https://outerspace.stsci.edu/login.action?os_destination=%2Fspaces%2FMASTDOCS%2Fpages%2F113771324%2FData%2BProduct%2BLinkages) if you already have an account.
search
attachments
weblink
advanced
...
image-attributes
image-effects
  * [ Paragraph ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
    * [Paragraph](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
    * [Heading 1](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
    * [Heading 2](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
    * [Heading 3](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
    * [Heading 4](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
    * [Heading 5](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
    * [Heading 6](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
    * [Preformatted](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
    * [Quote](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)


  * [ Bold ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
  * [ Italic ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
  * [ Underline ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
  * [Color picker](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
[More colors](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
    ...
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
  * [ Formatting ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
    * [ Clear formatting ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)


  * [ Bullet list ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
  * [ Numbered list ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)


  * [ Task list ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)


  * [ Outdent ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
  * [ Indent ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)


  * [ Align left ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
  * [ Align center ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
  * [ Align right ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)


  * [ Page layout ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)


  * [ Link ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)


  * [ Table ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)


  * [ Insert ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
Insert content
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
...
Insert macro
    ...
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
    * [ Other macros ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)


  * [ Page layout ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
    * [ No layout ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
    * [ Two column (simple) ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
    * [ Two column (simple, left sidebar) ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
    * [ Two column (simple, right sidebar) ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
    * [ Three column (simple) ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
    * [ Two column ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
    * [ Two column (left sidebar) ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
    * [ Two column (right sidebar) ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
    * [ Three column ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
    * [ Three column (left and right sidebars) ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)


  * [ Undo ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
  * [ Redo ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)


  * [ Find/Replace ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)


  * [ Keyboard shortcuts help ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)


You are not logged in. Any changes you make will be marked as anonymous. You may want to [Log In](https://outerspace.stsci.edu/login.action?os_destination=%2Fspaces%2FMASTDOCS%2Fpages%2F113771324%2FData%2BProduct%2BLinkages) if you already have an account.
This page is also being edited by 
If you are unable to use this CAPTCHA please [contact your administrator](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/administrators.action) for assistance.![CAPTCHA image](https://outerspace.stsci.edu/jcaptcha?id=1032480650)
Edit
Save
Close
  * [Preview](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
  * [View changes](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)


  * [Revert to last published version](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771324/Data+Product+Linkages)
