  * [Skip to main content](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/286852359/Finding+Solar+System+Bodies+in+MAST#title-heading)
  * [assistive.skiplink.to.breadcrumbs](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/286852359/Finding+Solar+System+Bodies+in+MAST#breadcrumbs)
  * [assistive.skiplink.to.header.menu](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/286852359/Finding+Solar+System+Bodies+in+MAST#rw_category_menu)
  * [assistive.skiplink.to.action.menu](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/286852359/Finding+Solar+System+Bodies+in+MAST#navigation)
  * [assistive.skiplink.to.quick.search](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/286852359/Finding+Solar+System+Bodies+in+MAST#rw_search_query)


  * [Skip to main content](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/286852359/Finding+Solar+System+Bodies+in+MAST#main "Skip to main content")
  * [Skip to breadcrumbs](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/286852359/Finding+Solar+System+Bodies+in+MAST#breadcrumbs)
  * [Skip to search](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/286852359/Finding+Solar+System+Bodies+in+MAST#quick-search-query)


  * [ Log in ](https://outerspace.stsci.edu/login.action?os_destination=%2Fspaces%2FMASTDOCS%2Fpages%2F286852359%2FFinding%2BSolar%2BSystem%2BBodies%2Bin%2BMAST "Login")
  * [ Help / Tips Help ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/286852359/Finding+Solar+System+Bodies+in+MAST "Help")
    * [ Online Help ](https://docs.atlassian.com/confluence/docs-95/ "Visit the Confluence documentation home")
    * [ Keyboard Shortcuts ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/286852359/Finding+Solar+System+Bodies+in+MAST "View available keyboard shortcuts")
...
[ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/286852359/Finding+Solar+System+Bodies+in+MAST "Open page in fullscreen \( Type 'F', shift + f \)")
  * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/286852359/Finding+Solar+System+Bodies+in+MAST)
    * [ Remove Read Confirmation  ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/286852359/Finding+Solar+System+Bodies+in+MAST)
    * [ A _t_ tachments (5)  ](https://outerspace.stsci.edu/pages/viewpageattachments.action?pageId=286852359 "View Attachments")
    * [ Page History  ](https://outerspace.stsci.edu/pages/viewpreviousversions.action?pageId=286852359)
    * [ Page Information  ](https://outerspace.stsci.edu/pages/viewinfo.action?pageId=286852359)
    * [ Resolved comments  ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/286852359/Finding+Solar+System+Bodies+in+MAST)
    * [ View in Hierarchy  ](https://outerspace.stsci.edu/pages/listpages-dirview.action?key=MASTDOCS&openId=286852359#selectedPageInHierarchy)
    * [ View Source  ](https://outerspace.stsci.edu/plugins/viewsource/viewpagesrc.action?pageId=286852359)
    * [ Export to PDF  ](https://outerspace.stsci.edu/spaces/flyingpdf/pdfpageexport.action?pageId=286852359&atl_token=498ee109f9d3b318634c34d07d249825a55fc99e)
    * [ Export to Word  ](https://outerspace.stsci.edu/exportword?pageId=286852359)
    * [ Page Labels  ](https://outerspace.stsci.edu/plugins/userlabeltool/pagebulklabeloperations.action?pageId=286852359)
    * [ Attachment Labels  ](https://outerspace.stsci.edu/plugins/userlabeltool/pagebulkattachmentoperations.action?pageId=286852359)
    * [ Hide Inline Comments  ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/286852359/$generalUtil.getIdBasedPageUrl\($page\))
...
[Skip to end of banner](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/286852359/Finding+Solar+System+Bodies+in+MAST#page-banner-end)
  * [](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/286852359/Finding+Solar+System+Bodies+in+MAST)[](https://outerspace.stsci.edu/pages/viewpageattachments.action?pageId=286852359&metadataLink=true)
  * [Jira links](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/286852359/Finding+Solar+System+Bodies+in+MAST)
  * [Workflow](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/286852359/Finding+Solar+System+Bodies+in+MAST)
  * [](https://outerspace.stsci.edu/spaces/viewtrackerreport.action?key=MASTDOCS)
  * [Read Confirmation](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/286852359/Finding+Solar+System+Bodies+in+MAST)


[Go to start of banner](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/286852359/Finding+Solar+System+Bodies+in+MAST#page-banner-start)
#  [Finding Solar System Bodies in MAST](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/286852359/Finding+Solar+System+Bodies+in+MAST)
  * Created by  ![User icon: shaw](https://outerspace.stsci.edu/s/aneund/9204/1jtwilc/_/images/icons/profilepics/anonymous.svg) [Richard A. Shaw](https://outerspace.stsci.edu/display/~shaw%0A), last updated on [Jul 09, 2025](https://outerspace.stsci.edu/pages/diffpagesbyversion.action?pageId=286852359&selectedPageVersions=1&selectedPageVersions=2 "Show changes") 6 minute read 
...
Crafting queries of such targets with MAST interfaces requires special attention because:
  ...
  * object names for solar system bodies are not resolvable to positions by standard catalog services (e.g., [Simbad](https://simbad.u-strasbg.fr/simbad/sim-basicIdent=m33&submit=SIMBAD+search), [NED](https://ned.ipac.caltech.edu/))
...
The equivalent [astroquery.mast](https://astroquery.readthedocs.io/en/latest/mast/mast.html) Observation.query_object() class parameter names are _`objectname`_and _`target_name`_, respectively.
...
**Figure 1 –** NASA/JPL Horizons System web interface, with selections to request the ephemeris for the asteroid _Didymos_ as observed from JWST in the time interval 2022-09-26 through 2022-10-15 (i.e. starting just before the date of the [DART](https://science.nasa.gov/mission/dart/) impact), in time steps of 6 hours. The apparent position of near-Earth asteroids can change quite rapidly. 
...
A [tutorial](https://outerspace.stsci.edu/display/PANSTARRS/How+to+search+for+moving+targets+in+PS1+images+and+catalogs) has been developed (with an accompanying [Jupyter notebook](https://ps1images.stsci.edu/ps1-moving-database-CADC.html)) to search for a known, but faint, asteroid in the Pan-STARRS catalog and to extract cut-out images from the survey images. To replicate this technique for other know solar system bodies, you will need: 
  * The [Solar System Object Image Search](https://www.cadc-ccda.hia-iha.nrc-cnrc.gc.ca/en/ssois/index.html#name) tool, developed by CADC
  * The [JPL Horizons Web interface](https://ssd.jpl.nasa.gov/horizons/)
...
The [Solar System Object Image Search](https://www.cadc-ccda.hia-iha.nrc-cnrc.gc.ca/en/ssois/index.html#name) tool can also search for images obtained by many of the HST instruments, the SDSS surveys, and many other non-MAST missions and observing facilities. The techniques described in the Pan-STARRS tutorial should be equally applicable. 
* * *
# For Further Reading...
  ...
  * [Solar System Object Image Search](https://www.cadc-ccda.hia-iha.nrc-cnrc.gc.ca/en/ssois/index.html#name) tool from CADC
