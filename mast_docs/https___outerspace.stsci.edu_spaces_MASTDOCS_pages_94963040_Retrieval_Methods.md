  * [Skip to main content](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods#title-heading)
  * [assistive.skiplink.to.breadcrumbs](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods#breadcrumbs)
  * [assistive.skiplink.to.header.menu](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods#rw_category_menu)
  * [assistive.skiplink.to.action.menu](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods#navigation)
  * [assistive.skiplink.to.quick.search](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods#rw_search_query)


  * [Skip to main content](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods#main "Skip to main content \(Type 'u' then '8'\)")
  * [Skip to breadcrumbs](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods#breadcrumbs)
  * [Skip to search](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods#quick-search-query)


  * [ Log in ](https://outerspace.stsci.edu/login.action?os_destination=%2Fspaces%2FMASTDOCS%2Fpages%2F94963040%2FRetrieval%2BMethods "Login")
  * [ Help / Tips Help ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods "Help")
    * [ Online Help ](https://docs.atlassian.com/confluence/docs-95/ "Visit the Confluence documentation home")
    * [ Keyboard Shortcuts ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods "View available keyboard shortcuts \(Type '?'\)")
  ...
  * [](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)
    * [Forums](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods "Forums")
...
[ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods "Open page in fullscreen \( Type 'F', shift + f \)")
  * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)
    * [ Remove Read Confirmation  ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)
    * [ A _t_ tachments (18)  ](https://outerspace.stsci.edu/pages/viewpageattachments.action?pageId=94963040 "View Attachments \(Type 't'\)")
    * [ Page History  ](https://outerspace.stsci.edu/pages/viewpreviousversions.action?pageId=94963040)
    * [ Page Information  ](https://outerspace.stsci.edu/pages/viewinfo.action?pageId=94963040)
    * [ Resolved comments  ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)
    * [ View in Hierarchy  ](https://outerspace.stsci.edu/pages/listpages-dirview.action?key=MASTDOCS&openId=94963040#selectedPageInHierarchy)
    * [ View Source  ](https://outerspace.stsci.edu/plugins/viewsource/viewpagesrc.action?pageId=94963040)
    * [ Export to PDF  ](https://outerspace.stsci.edu/spaces/flyingpdf/pdfpageexport.action?pageId=94963040&atl_token=4fbee8de6962bdf33ba8100d353732d7750a69e9)
    * [ Export to Word  ](https://outerspace.stsci.edu/exportword?pageId=94963040)
    * [ Page Labels  ](https://outerspace.stsci.edu/plugins/userlabeltool/pagebulklabeloperations.action?pageId=94963040)
    * [ Attachment Labels  ](https://outerspace.stsci.edu/plugins/userlabeltool/pagebulkattachmentoperations.action?pageId=94963040)
    * [ Hide Inline Comments  ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/$generalUtil.getIdBasedPageUrl\($page\))
...
[Skip to end of banner](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods#page-banner-end)
  * [](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)[](https://outerspace.stsci.edu/pages/viewpageattachments.action?pageId=94963040&metadataLink=true)
  * [Jira links](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)
  * [Workflow](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)
  * [2,119 views](https://outerspace.stsci.edu/spaces/viewtrackerreport.action?key=MASTDOCS)
  * [Read Confirmation](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)


[Go to start of banner](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods#page-banner-start)
#  [Retrieval Methods](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)
  * Created by  ![User icon: shaw](https://outerspace.stsci.edu/s/aneund/9204/1jtwilc/_/images/icons/profilepics/anonymous.svg) [Richard A. Shaw](https://outerspace.stsci.edu/display/~shaw%0A), last updated on [Nov 13, 2023](https://outerspace.stsci.edu/pages/diffpagesbyversion.action?pageId=94963040&selectedPageVersions=63&selectedPageVersions=64 "Show changes") 7 minute read 
...
Please see the [Archive Support Knowledge Base](https://stsci.service-now.com/mast?id=kb_article_view&sys_kb_id=bea9ac1edb3acb4042685434ce96198c) for more details on each of these clients, and to explore other options.
Cyberduck (Click here to expand...)
To download the app or for more help, please see the [Cyberduck](https://cyberduck.io/) site.
...
To download the app or for more help, please see the [FileZilla](https://filezilla-project.org/)site.
Launch the app.
...
To install wget or for more help, please see the [wget](https://www.gnu.org/software/wget/)site.
Bring up a shell.
...
To install curl or for more help, please see the [curl](https://curl.se/) site. Curl is likely already installed on many machines, and if not, is freely available as open source software.
...
It is possible to search for and retrieve data using MAST web services, or the Python [**astroquery.mast**](https://astroquery.readthedocs.io/en/latest/mast/mast.html) library. These methods are described in [Beyond the Portal](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94962884/Beyond+the+Portal).
# For Further Reading...
  ...
  * [ftp](https://outerspace.stsci.edu/label/MASTDOCS/ftp)
...
null
  ...
  7. [Retrieval Methods](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)


You are not logged in. Any changes you make will be marked as anonymous. You may want to [Log In](https://outerspace.stsci.edu/login.action?os_destination=%2Fspaces%2FMASTDOCS%2Fpages%2F94963040%2FRetrieval%2BMethods) if you already have an account.
search
attachments
weblink
advanced
...
image-attributes
image-effects
  * [ Paragraph ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)
    * [Paragraph](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)
    * [Heading 1](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)
    * [Heading 2](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)
    * [Heading 3](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)
    * [Heading 4](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)
    * [Heading 5](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)
    * [Heading 6](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)
    * [Preformatted](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)
    * [Quote](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)


  * [ Bold ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)
  * [ Italic ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)
  * [ Underline ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)
  * [Color picker](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)
[More colors](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)
    ...
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)
  * [ Formatting ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)
    * [ Clear formatting ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)


  * [ Bullet list ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)
  * [ Numbered list ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)


  * [ Task list ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)


  * [ Outdent ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)
  * [ Indent ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)


  * [ Align left ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)
  * [ Align center ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)
  * [ Align right ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)


  * [ Page layout ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)


  * [ Link ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)


  * [ Table ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)


  * [ Insert ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)
Insert content
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)
...
Insert macro
    ...
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)
    * [ Other macros ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)


  * [ Page layout ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)
    * [ No layout ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)
    * [ Two column (simple) ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)
    * [ Two column (simple, left sidebar) ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)
    * [ Two column (simple, right sidebar) ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)
    * [ Three column (simple) ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)
    * [ Two column ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)
    * [ Two column (left sidebar) ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)
    * [ Two column (right sidebar) ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)
    * [ Three column ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)
    * [ Three column (left and right sidebars) ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)


  * [ Undo ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)
  * [ Redo ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)


  * [ Find/Replace ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)


  * [ Keyboard shortcuts help ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)


You are not logged in. Any changes you make will be marked as anonymous. You may want to [Log In](https://outerspace.stsci.edu/login.action?os_destination=%2Fspaces%2FMASTDOCS%2Fpages%2F94963040%2FRetrieval%2BMethods) if you already have an account.
This page is also being edited by 
If you are unable to use this CAPTCHA please [contact your administrator](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/administrators.action) for assistance.![CAPTCHA image](https://outerspace.stsci.edu/jcaptcha?id=619687762)
Edit
Save
Close
  * [Preview](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)
  * [View changes](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)


  * [Revert to last published version](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94963040/Retrieval+Methods)
