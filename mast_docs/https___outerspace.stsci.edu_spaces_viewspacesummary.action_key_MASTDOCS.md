  * [Skip to main content](https://outerspace.stsci.edu/spaces/viewspacesummary.action?key=MASTDOCS#title-heading)
  * [assistive.skiplink.to.breadcrumbs](https://outerspace.stsci.edu/spaces/viewspacesummary.action?key=MASTDOCS#breadcrumbs)
  * [assistive.skiplink.to.header.menu](https://outerspace.stsci.edu/spaces/viewspacesummary.action?key=MASTDOCS#rw_category_menu)
  * [assistive.skiplink.to.action.menu](https://outerspace.stsci.edu/spaces/viewspacesummary.action?key=MASTDOCS#navigation)
  * [assistive.skiplink.to.quick.search](https://outerspace.stsci.edu/spaces/viewspacesummary.action?key=MASTDOCS#rw_search_query)


  * [Skip to main content](https://outerspace.stsci.edu/spaces/viewspacesummary.action?key=MASTDOCS#main "Skip to main content \(Type 'u' then '8'\)")
  * [Skip to search](https://outerspace.stsci.edu/spaces/viewspacesummary.action?key=MASTDOCS#quick-search-query)


  * [ Log in ](https://outerspace.stsci.edu/login.action?os_destination=%2Fspaces%2Fviewspacesummary.action%3Fkey%3DMASTDOCS "Login")
  * [ Help / Tips Help ](https://outerspace.stsci.edu/spaces/viewspacesummary.action?key=MASTDOCS "Help")
    * [ Online Help ](https://docs.atlassian.com/confluence/docs-95/ "Visit the Confluence documentation home")
    * [ Keyboard Shortcuts ](https://outerspace.stsci.edu/spaces/viewspacesummary.action?key=MASTDOCS "View available keyboard shortcuts \(Type '?'\)")
  ...
  * [](https://outerspace.stsci.edu/spaces/viewspacesummary.action?key=MASTDOCS)
    * [Forums](https://outerspace.stsci.edu/spaces/viewspacesummary.action?key=MASTDOCS "Forums")
...
[ ](https://outerspace.stsci.edu/spaces/viewspacesummary.action?key=MASTDOCS "Open page in fullscreen \( Type 'F', shift + f \)")
#  Space Tools 
  ...
  * [Space Details](https://outerspace.stsci.edu/spaces/viewspacesummary.action?key=MASTDOCS "Space Details")


Name MAST Docs Key MASTDOCS Home page Home page: [MAST User Documentation](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/94962815/MAST+User+Documentation) Created by [Paul Mulgrew](https://outerspace.stsci.edu/display/~pmulgrew%0A) (Feb 18, 2021) Categories (None)  Description *Space curator=Dick Shaw Administrators [Adrian Lucy](https://outerspace.stsci.edu/display/~alucy%0A), [Peter Forshay](https://outerspace.stsci.edu/display/~pforshay%0A), [Rick White](https://outerspace.stsci.edu/display/~rlw%0A), [Scott Fleming](https://outerspace.stsci.edu/display/~fleming%0A), [Thomas Dutkiewicz](https://outerspace.stsci.edu/display/~tdutkiewicz%0A)  
---  
null
