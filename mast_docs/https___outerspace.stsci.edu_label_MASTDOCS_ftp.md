  * [Skip to main content](https://outerspace.stsci.edu/label/MASTDOCS/ftp#title-heading)
  * [assistive.skiplink.to.breadcrumbs](https://outerspace.stsci.edu/label/MASTDOCS/ftp#breadcrumbs)
  * [assistive.skiplink.to.header.menu](https://outerspace.stsci.edu/label/MASTDOCS/ftp#rw_category_menu)
  * [assistive.skiplink.to.action.menu](https://outerspace.stsci.edu/label/MASTDOCS/ftp#navigation)
  * [assistive.skiplink.to.quick.search](https://outerspace.stsci.edu/label/MASTDOCS/ftp#rw_search_query)


  * [Skip to main content](https://outerspace.stsci.edu/label/MASTDOCS/ftp#main "Skip to main content \(Type 'u' then '8'\)")
  * [Skip to search](https://outerspace.stsci.edu/label/MASTDOCS/ftp#quick-search-query)


  * [ Log in ](https://outerspace.stsci.edu/login.action?os_destination=%2Flabel%2FMASTDOCS%2Fftp "Login")
  * [ Help / Tips Help ](https://outerspace.stsci.edu/label/MASTDOCS/ftp "Help")
    * [ Online Help ](https://docs.atlassian.com/confluence/docs-95/ "Visit the Confluence documentation home")
    * [ Keyboard Shortcuts ](https://outerspace.stsci.edu/label/MASTDOCS/ftp "View available keyboard shortcuts \(Type '?'\)")
  ...
  * [](https://outerspace.stsci.edu/label/MASTDOCS/ftp)
    * [Forums](https://outerspace.stsci.edu/label/MASTDOCS/ftp "Forums")
...
[ ](https://outerspace.stsci.edu/label/MASTDOCS/ftp "Open page in fullscreen \( Type 'F', shift + f \)")
Settings
  * [See content from all spaces](https://outerspace.stsci.edu/label/ftp)
...
#  Labeled content 
Related Labels
  * [download](https://outerspace.stsci.edu/label/MASTDOCS/download+ftp)
  * [mast](https://outerspace.stsci.edu/label/MASTDOCS/ftp+mast)
  * [portal](https://outerspace.stsci.edu/label/MASTDOCS/ftp+portal)
