  * [Skip to main content](https://outerspace.stsci.edu/label/MASTDOCS/help_desk#title-heading)
  * [assistive.skiplink.to.breadcrumbs](https://outerspace.stsci.edu/label/MASTDOCS/help_desk#breadcrumbs)
  * [assistive.skiplink.to.header.menu](https://outerspace.stsci.edu/label/MASTDOCS/help_desk#rw_category_menu)
  * [assistive.skiplink.to.action.menu](https://outerspace.stsci.edu/label/MASTDOCS/help_desk#navigation)
  * [assistive.skiplink.to.quick.search](https://outerspace.stsci.edu/label/MASTDOCS/help_desk#rw_search_query)


  * [Skip to main content](https://outerspace.stsci.edu/label/MASTDOCS/help_desk#main "Skip to main content \(Type 'u' then '8'\)")
  * [Skip to search](https://outerspace.stsci.edu/label/MASTDOCS/help_desk#quick-search-query)


  * [ Log in ](https://outerspace.stsci.edu/login.action?os_destination=%2Flabel%2FMASTDOCS%2Fhelp_desk "Login")
  * [ Help / Tips Help ](https://outerspace.stsci.edu/label/MASTDOCS/help_desk "Help")
    * [ Online Help ](https://docs.atlassian.com/confluence/docs-95/ "Visit the Confluence documentation home")
    * [ Keyboard Shortcuts ](https://outerspace.stsci.edu/label/MASTDOCS/help_desk "View available keyboard shortcuts \(Type '?'\)")
  ...
  * [](https://outerspace.stsci.edu/label/MASTDOCS/help_desk)
    * [Forums](https://outerspace.stsci.edu/label/MASTDOCS/help_desk "Forums")
...
[ ](https://outerspace.stsci.edu/label/MASTDOCS/help_desk "Open page in fullscreen \( Type 'F', shift + f \)")
Settings
  * [See content from all spaces](https://outerspace.stsci.edu/label/help_desk)
...
#  Labeled content 
Related Labels
  * [mast](https://outerspace.stsci.edu/label/MASTDOCS/help_desk+mast)
...
Mar 05, 2021 •  [Richard A. Shaw](https://outerspace.stsci.edu/display/~shaw%0A)
