  * [Skip to main content](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ#title-heading)
  * [assistive.skiplink.to.breadcrumbs](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ#breadcrumbs)
  * [assistive.skiplink.to.header.menu](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ#rw_category_menu)
  * [assistive.skiplink.to.action.menu](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ#navigation)
  * [assistive.skiplink.to.quick.search](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ#rw_search_query)


  * [Skip to main content](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ#main "Skip to main content \(Type 'u' then '8'\)")
  * [Skip to breadcrumbs](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ#breadcrumbs)
  * [Skip to search](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ#quick-search-query)


  * [ Log in ](https://outerspace.stsci.edu/login.action?os_destination=%2Fspaces%2FMASTDOCS%2Fpages%2F232358851%2FFAQ "Login")
  * [ Help / Tips Help ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ "Help")
    * [ Online Help ](https://docs.atlassian.com/confluence/docs-95/ "Visit the Confluence documentation home")
    * [ Keyboard Shortcuts ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ "View available keyboard shortcuts \(Type '?'\)")
  ...
  * [](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)
    * [Forums](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ "Forums")
...
[ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ "Open page in fullscreen \( Type 'F', shift + f \)")
  * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)
    * [ Remove Read Confirmation  ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)
    * [ A _t_ tachments (1)  ](https://outerspace.stsci.edu/pages/viewpageattachments.action?pageId=232358851 "View Attachments \(Type 't'\)")
    * [ Page History  ](https://outerspace.stsci.edu/pages/viewpreviousversions.action?pageId=232358851)
    * [ Page Information  ](https://outerspace.stsci.edu/pages/viewinfo.action?pageId=232358851)
    * [ Resolved comments  ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)
    * [ View in Hierarchy  ](https://outerspace.stsci.edu/pages/listpages-dirview.action?key=MASTDOCS&openId=232358851#selectedPageInHierarchy)
    * [ View Source  ](https://outerspace.stsci.edu/plugins/viewsource/viewpagesrc.action?pageId=232358851)
    * [ Export to PDF  ](https://outerspace.stsci.edu/spaces/flyingpdf/pdfpageexport.action?pageId=232358851&atl_token=498ee109f9d3b318634c34d07d249825a55fc99e)
    * [ Export to Word  ](https://outerspace.stsci.edu/exportword?pageId=232358851)
    * [ Page Labels  ](https://outerspace.stsci.edu/plugins/userlabeltool/pagebulklabeloperations.action?pageId=232358851)
    * [ Attachment Labels  ](https://outerspace.stsci.edu/plugins/userlabeltool/pagebulkattachmentoperations.action?pageId=232358851)
    * [ Hide Inline Comments  ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/$generalUtil.getIdBasedPageUrl\($page\))
...
[Skip to end of banner](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ#page-banner-end)
  * [](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)[](https://outerspace.stsci.edu/pages/viewpageattachments.action?pageId=232358851&metadataLink=true)
  * [Jira links](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)
  * [Workflow](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)
  * [376 views](https://outerspace.stsci.edu/spaces/viewtrackerreport.action?key=MASTDOCS)
  * [Read Confirmation](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)


[Go to start of banner](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ#page-banner-start)
#  [FAQ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)
  * Created by  ![User icon: shaw](https://outerspace.stsci.edu/s/aneund/9204/1jtwilc/_/images/icons/profilepics/anonymous.svg) [Richard A. Shaw](https://outerspace.stsci.edu/display/~shaw%0A), last updated by  [Adrian Lucy](https://outerspace.stsci.edu/display/~alucy%0A) on [Aug 04, 2025](https://outerspace.stsci.edu/pages/diffpagesbyversion.action?pageId=232358851&selectedPageVersions=28&selectedPageVersions=29 "Show changes") 6 minute read 
...
### How do I search for solar system bodies in MAST
...
This problem of loading too many files in the basket is particularly likely for JWST Observations with many extracted spectra (e.g., NIRCam Wide-Field Slitless Spectra), or Observations containing lots of spatial dithers or other spacecraft maneuvers (as for an extended mosaic or moving targets). To get around this problem you can do the following:
  ...
  2. Use the [astroquery.mast](https://astroquery.readthedocs.io/en/latest/mast/mast.html) API. See the __Astroquery Search and Retrieval__ section of the [Using MAST APIs](https://outerspace.stsci.edu/display/MASTDOCS/Using+MAST+APIs) article. Follow the link to the Jupyter Notebook for API Large Downloads.
...
There are multiple ways to discover JWST Observations. For instance:
  ...
  * Using the Python library **astroquery.mast** , form a _**query_criteria**_ _`obs_collection="JWST"`_and some other parameters such as _`instrument_name="MIRI*"`_. See the[astroquery.mast](https://astroquery.readthedocs.io/en/latest/mast/mast.html#observation-criteria-queries) documentation for details.
...
For questions not addressed in the FAQ, please contact the Archive Help Desk (archive@stsci.edu).
  ...
  * [faq](https://outerspace.stsci.edu/label/MASTDOCS/faq)
...
null
  ...
  5. [FAQ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)


You are not logged in. Any changes you make will be marked as anonymous. You may want to [Log In](https://outerspace.stsci.edu/login.action?os_destination=%2Fspaces%2FMASTDOCS%2Fpages%2F232358851%2FFAQ) if you already have an account.
search
attachments
weblink
advanced
...
image-attributes
image-effects
  * [ Paragraph ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)
    * [Paragraph](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)
    * [Heading 1](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)
    * [Heading 2](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)
    * [Heading 3](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)
    * [Heading 4](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)
    * [Heading 5](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)
    * [Heading 6](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)
    * [Preformatted](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)
    * [Quote](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)


  * [ Bold ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)
  * [ Italic ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)
  * [ Underline ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)
  * [Color picker](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)
[More colors](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)
    ...
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)
  * [ Formatting ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)
    * [ Clear formatting ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)


  * [ Bullet list ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)
  * [ Numbered list ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)


  * [ Task list ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)


  * [ Outdent ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)
  * [ Indent ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)


  * [ Align left ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)
  * [ Align center ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)
  * [ Align right ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)


  * [ Page layout ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)


  * [ Link ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)


  * [ Table ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)


  * [ Insert ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)
Insert content
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)
...
Insert macro
    ...
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)
    * [ Other macros ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)


  * [ Page layout ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)
    * [ No layout ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)
    * [ Two column (simple) ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)
    * [ Two column (simple, left sidebar) ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)
    * [ Two column (simple, right sidebar) ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)
    * [ Three column (simple) ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)
    * [ Two column ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)
    * [ Two column (left sidebar) ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)
    * [ Two column (right sidebar) ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)
    * [ Three column ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)
    * [ Three column (left and right sidebars) ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)


  * [ Undo ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)
  * [ Redo ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)


  * [ Find/Replace ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)


  * [ Keyboard shortcuts help ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)


You are not logged in. Any changes you make will be marked as anonymous. You may want to [Log In](https://outerspace.stsci.edu/login.action?os_destination=%2Fspaces%2FMASTDOCS%2Fpages%2F232358851%2FFAQ) if you already have an account.
This page is also being edited by 
If you are unable to use this CAPTCHA please [contact your administrator](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/administrators.action) for assistance.![CAPTCHA image](https://outerspace.stsci.edu/jcaptcha?id=458603899)
Edit
Save
Close
  * [Preview](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)
  * [View changes](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)


  * [Revert to last published version](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/232358851/FAQ)
