  * [Skip to main content](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar#title-heading)
  * [assistive.skiplink.to.breadcrumbs](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar#breadcrumbs)
  * [assistive.skiplink.to.header.menu](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar#rw_category_menu)
  * [assistive.skiplink.to.action.menu](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar#navigation)
  * [assistive.skiplink.to.quick.search](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar#rw_search_query)


  * [Skip to main content](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar#main "Skip to main content \(Type 'u' then '8'\)")
  * [Skip to breadcrumbs](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar#breadcrumbs)
  * [Skip to search](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar#quick-search-query)


  * [ Log in ](https://outerspace.stsci.edu/login.action?os_destination=%2Fspaces%2FMASTDOCS%2Fpages%2F104958267%2FThe%2BSearch%2BBar "Login")
  * [ Help / Tips Help ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar "Help")
    * [ Online Help ](https://docs.atlassian.com/confluence/docs-95/ "Visit the Confluence documentation home")
    * [ Keyboard Shortcuts ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar "View available keyboard shortcuts \(Type '?'\)")
  ...
  * [](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)
    * [Forums](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar "Forums")
...
[ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar "Open page in fullscreen \( Type 'F', shift + f \)")
  * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)
    * [ Remove Read Confirmation  ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)
    * [ A _t_ tachments (3)  ](https://outerspace.stsci.edu/pages/viewpageattachments.action?pageId=104958267 "View Attachments \(Type 't'\)")
    * [ Page History  ](https://outerspace.stsci.edu/pages/viewpreviousversions.action?pageId=104958267)
    * [ Page Information  ](https://outerspace.stsci.edu/pages/viewinfo.action?pageId=104958267)
    * [ Resolved comments (0) ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)
    * [ View in Hierarchy  ](https://outerspace.stsci.edu/pages/listpages-dirview.action?key=MASTDOCS&openId=104958267#selectedPageInHierarchy)
    * [ View Source  ](https://outerspace.stsci.edu/plugins/viewsource/viewpagesrc.action?pageId=104958267)
    * [ Export to PDF  ](https://outerspace.stsci.edu/spaces/flyingpdf/pdfpageexport.action?pageId=104958267&atl_token=4fbee8de6962bdf33ba8100d353732d7750a69e9)
    * [ Export to Word  ](https://outerspace.stsci.edu/exportword?pageId=104958267)
    * [ Page Labels  ](https://outerspace.stsci.edu/plugins/userlabeltool/pagebulklabeloperations.action?pageId=104958267)
    * [ Attachment Labels  ](https://outerspace.stsci.edu/plugins/userlabeltool/pagebulkattachmentoperations.action?pageId=104958267)
    * [ Hide Inline Comments  ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/$generalUtil.getIdBasedPageUrl\($page\))
...
[Skip to end of banner](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar#page-banner-end)
  * [](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)[](https://outerspace.stsci.edu/pages/viewpageattachments.action?pageId=104958267&metadataLink=true)
  * [Jira links](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)
  * [Workflow](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)
  * [327 views](https://outerspace.stsci.edu/spaces/viewtrackerreport.action?key=MASTDOCS)
  * [Read Confirmation](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)


[Go to start of banner](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar#page-banner-start)
#  [The Search Bar](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)
  * Created by  ![User icon: fleming](https://outerspace.stsci.edu/s/aneund/9204/1jtwilc/_/images/icons/profilepics/anonymous.svg) [Scott Fleming](https://outerspace.stsci.edu/display/~fleming%0A), last updated on [Aug 31, 2021](https://outerspace.stsci.edu/pages/diffpagesbyversion.action?pageId=104958267&selectedPageVersions=15&selectedPageVersions=16 "Show changes") 2 minute read 


On this page...
  * [The "Clear Form" Button](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar#TheSearchBar-clear_form_button)
  * [The "Search" Button](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar#TheSearchBar-search_button)
  * [The "Show API" Button](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar#TheSearchBar-show_api_button)


# Component Overview
This section describes the Search Bar, which is available at the bottom of the Search Form.
## Component Features and Functionality
The Search Bar consists of three buttons: '**CLEAR FORM** ', '**SEARCH** ', and '**SHOW API QUERY** '.
* * *
![](https://outerspace.stsci.edu/download/thumbnails/104958267/thesearchbar_clearform.png?version=1&modificationDate=1629837494510&api=v2)
The "CLEAR FORM" Button
**'CLEAR FORM'** resets the form to its default values: all changes made to the form are removed. Use this button to start a new search.
![](https://outerspace.stsci.edu/download/thumbnails/104958267/thesearchbar_search.png?version=1&modificationDate=1629837494472&api=v2)
The "SEARCH" Button
**'SEARCH'** submits the query as entered in the search form and shows the results in the [Search Results Table](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/107840287/Search+Results+Page).
![](https://outerspace.stsci.edu/download/thumbnails/104958267/thesearchbar_showapiquery.png?version=1&modificationDate=1629837494435&api=v2)
The "SHOW API QUERY" Button
'**SHOW API QUERY'** opens an overlay with a written, programmatic-based query, which can be used in a terminal or included in programming scripts. The API queries shown in the overlay match the search constraints specified in the search form.
* * *
# For Further Reading...
...
null
  ...
  7. [The Search Bar](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)


You are not logged in. Any changes you make will be marked as anonymous. You may want to [Log In](https://outerspace.stsci.edu/login.action?os_destination=%2Fspaces%2FMASTDOCS%2Fpages%2F104958267%2FThe%2BSearch%2BBar) if you already have an account.
search
attachments
weblink
advanced
...
image-attributes
image-effects
  * [ Paragraph ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)
    * [Paragraph](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)
    * [Heading 1](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)
    * [Heading 2](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)
    * [Heading 3](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)
    * [Heading 4](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)
    * [Heading 5](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)
    * [Heading 6](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)
    * [Preformatted](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)
    * [Quote](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)


  * [ Bold ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)
  * [ Italic ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)
  * [ Underline ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)
  * [Color picker](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)
[More colors](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)
    ...
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)
  * [ Formatting ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)
    * [ Clear formatting ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)


  * [ Bullet list ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)
  * [ Numbered list ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)


  * [ Task list ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)


  * [ Outdent ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)
  * [ Indent ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)


  * [ Align left ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)
  * [ Align center ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)
  * [ Align right ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)


  * [ Page layout ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)


  * [ Link ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)


  * [ Table ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)


  * [ Insert ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)
Insert content
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)
...
Insert macro
    ...
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)
    * [ Other macros ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)


  * [ Page layout ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)
    * [ No layout ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)
    * [ Two column (simple) ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)
    * [ Two column (simple, left sidebar) ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)
    * [ Two column (simple, right sidebar) ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)
    * [ Three column (simple) ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)
    * [ Two column ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)
    * [ Two column (left sidebar) ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)
    * [ Two column (right sidebar) ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)
    * [ Three column ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)
    * [ Three column (left and right sidebars) ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)


  * [ Undo ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)
  * [ Redo ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)


  * [ Find/Replace ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)


  * [ Keyboard shortcuts help ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)


You are not logged in. Any changes you make will be marked as anonymous. You may want to [Log In](https://outerspace.stsci.edu/login.action?os_destination=%2Fspaces%2FMASTDOCS%2Fpages%2F104958267%2FThe%2BSearch%2BBar) if you already have an account.
This page is also being edited by 
If you are unable to use this CAPTCHA please [contact your administrator](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/administrators.action) for assistance.![CAPTCHA image](https://outerspace.stsci.edu/jcaptcha?id=-1176524432)
Connecting...
Edit
Save
Close
  * [Preview](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)
  * [View changes](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)


  * [Revert to last published version](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958267/The+Search+Bar)
