  * [Skip to main content](https://outerspace.stsci.edu/site/mast#title-heading)
  * [assistive.skiplink.to.breadcrumbs](https://outerspace.stsci.edu/site/mast#breadcrumbs)
  * [assistive.skiplink.to.header.menu](https://outerspace.stsci.edu/site/mast#rw_category_menu)
  * [assistive.skiplink.to.action.menu](https://outerspace.stsci.edu/site/mast#navigation)
  * [assistive.skiplink.to.quick.search](https://outerspace.stsci.edu/site/mast#rw_search_query)


  * [Skip to main content](https://outerspace.stsci.edu/site/mast#main "Skip to main content \(Type 'u' then '8'\)")
  * [Skip to search](https://outerspace.stsci.edu/site/mast#quick-search-query)


  * [ Log in ](https://outerspace.stsci.edu/login.action?os_destination=%2Fsite%2Fmast "Login")
  * [ Help / Tips Help ](https://outerspace.stsci.edu/site/mast "Help")
    * [ Online Help ](https://docs.atlassian.com/confluence/docs-95/ "Visit the Confluence documentation home")
    * [ Keyboard Shortcuts ](https://outerspace.stsci.edu/site/mast "View available keyboard shortcuts \(Type '?'\)")
  ...
  * [](https://outerspace.stsci.edu/site/mast)
    * [Forums](https://outerspace.stsci.edu/site/mast "Forums")
...
Hit enter to search
## Welcome to MAST
The Mikulski Archive for Space Telescopes Use the Navigation Highlight module to display content that matters.
all
undefined
true
true
