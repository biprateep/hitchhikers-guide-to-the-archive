  * [Skip to main content](https://outerspace.stsci.edu/label/MASTDOCS/hlsp+metadata#title-heading)
  * [assistive.skiplink.to.breadcrumbs](https://outerspace.stsci.edu/label/MASTDOCS/hlsp+metadata#breadcrumbs)
  * [assistive.skiplink.to.header.menu](https://outerspace.stsci.edu/label/MASTDOCS/hlsp+metadata#rw_category_menu)
  * [assistive.skiplink.to.action.menu](https://outerspace.stsci.edu/label/MASTDOCS/hlsp+metadata#navigation)
  * [assistive.skiplink.to.quick.search](https://outerspace.stsci.edu/label/MASTDOCS/hlsp+metadata#rw_search_query)


  * [Skip to main content](https://outerspace.stsci.edu/label/MASTDOCS/hlsp+metadata#main "Skip to main content \(Type 'u' then '8'\)")
  * [Skip to search](https://outerspace.stsci.edu/label/MASTDOCS/hlsp+metadata#quick-search-query)


  * [ Log in ](https://outerspace.stsci.edu/login.action?os_destination=%2Flabel%2FMASTDOCS%2Fhlsp%2Bmetadata "Login")
  * [ Help / Tips Help ](https://outerspace.stsci.edu/label/MASTDOCS/hlsp+metadata "Help")
    * [ Online Help ](https://docs.atlassian.com/confluence/docs-95/ "Visit the Confluence documentation home")
    * [ Keyboard Shortcuts ](https://outerspace.stsci.edu/label/MASTDOCS/hlsp+metadata "View available keyboard shortcuts \(Type '?'\)")
  ...
  * [](https://outerspace.stsci.edu/label/MASTDOCS/hlsp+metadata)
    * [Forums](https://outerspace.stsci.edu/label/MASTDOCS/hlsp+metadata "Forums")
...
[ ](https://outerspace.stsci.edu/label/MASTDOCS/hlsp+metadata "Open page in fullscreen \( Type 'F', shift + f \)")
Settings
  * [See content from all spaces](https://outerspace.stsci.edu/label/hlsp+metadata)
...
#  Labeled content 
Related Labels
  * [jwst](https://outerspace.stsci.edu/label/MASTDOCS/hlsp+jwst+metadata)
  * [mast](https://outerspace.stsci.edu/label/MASTDOCS/hlsp+mast+metadata)
  * [doi](https://outerspace.stsci.edu/label/MASTDOCS/doi+hlsp+metadata)
  * [search](https://outerspace.stsci.edu/label/MASTDOCS/hlsp+metadata+search)


Every content item in this list is tagged with all the required labels: 
  * [hlsp](https://outerspace.stsci.edu/label/MASTDOCS/metadata)
  * [metadata](https://outerspace.stsci.edu/label/MASTDOCS/hlsp)
