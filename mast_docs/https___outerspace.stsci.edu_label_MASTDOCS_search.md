  * [Skip to main content](https://outerspace.stsci.edu/label/MASTDOCS/search#title-heading)
  * [assistive.skiplink.to.breadcrumbs](https://outerspace.stsci.edu/label/MASTDOCS/search#breadcrumbs)
  * [assistive.skiplink.to.header.menu](https://outerspace.stsci.edu/label/MASTDOCS/search#rw_category_menu)
  * [assistive.skiplink.to.action.menu](https://outerspace.stsci.edu/label/MASTDOCS/search#navigation)
  * [assistive.skiplink.to.quick.search](https://outerspace.stsci.edu/label/MASTDOCS/search#rw_search_query)


  * [Skip to main content](https://outerspace.stsci.edu/label/MASTDOCS/search#main "Skip to main content \(Type 'u' then '8'\)")
  * [Skip to search](https://outerspace.stsci.edu/label/MASTDOCS/search#quick-search-query)


  * [ Log in ](https://outerspace.stsci.edu/login.action?os_destination=%2Flabel%2FMASTDOCS%2Fsearch "Login")
  * [ Help / Tips Help ](https://outerspace.stsci.edu/label/MASTDOCS/search "Help")
    * [ Online Help ](https://docs.atlassian.com/confluence/docs-95/ "Visit the Confluence documentation home")
    * [ Keyboard Shortcuts ](https://outerspace.stsci.edu/label/MASTDOCS/search "View available keyboard shortcuts \(Type '?'\)")
  ...
  * [](https://outerspace.stsci.edu/label/MASTDOCS/search)
    * [Forums](https://outerspace.stsci.edu/label/MASTDOCS/search "Forums")
...
[ ](https://outerspace.stsci.edu/label/MASTDOCS/search "Open page in fullscreen \( Type 'F', shift + f \)")
Settings
  * [See content from all spaces](https://outerspace.stsci.edu/label/search)
...
#  Labeled content 
Related Labels
  * [hlsp](https://outerspace.stsci.edu/label/MASTDOCS/hlsp+search)
