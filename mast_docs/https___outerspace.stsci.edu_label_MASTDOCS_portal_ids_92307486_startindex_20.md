  * [Skip to main content](https://outerspace.stsci.edu/label/MASTDOCS/portal?ids=92307486&startindex=20#title-heading)
  * [assistive.skiplink.to.breadcrumbs](https://outerspace.stsci.edu/label/MASTDOCS/portal?ids=92307486&startindex=20#breadcrumbs)
  * [assistive.skiplink.to.header.menu](https://outerspace.stsci.edu/label/MASTDOCS/portal?ids=92307486&startindex=20#rw_category_menu)
  * [assistive.skiplink.to.action.menu](https://outerspace.stsci.edu/label/MASTDOCS/portal?ids=92307486&startindex=20#navigation)
  * [assistive.skiplink.to.quick.search](https://outerspace.stsci.edu/label/MASTDOCS/portal?ids=92307486&startindex=20#rw_search_query)


  * [Skip to main content](https://outerspace.stsci.edu/label/MASTDOCS/portal?ids=92307486&startindex=20#main "Skip to main content \(Type 'u' then '8'\)")
  * [Skip to search](https://outerspace.stsci.edu/label/MASTDOCS/portal?ids=92307486&startindex=20#quick-search-query)


  * [ Log in ](https://outerspace.stsci.edu/login.action?os_destination=%2Flabel%2FMASTDOCS%2Fportal%3Fids%3D92307486%26startindex%3D20 "Login")
  * [ Help / Tips Help ](https://outerspace.stsci.edu/label/MASTDOCS/portal?ids=92307486&startindex=20 "Help")
    * [ Online Help ](https://docs.atlassian.com/confluence/docs-95/ "Visit the Confluence documentation home")
    * [ Keyboard Shortcuts ](https://outerspace.stsci.edu/label/MASTDOCS/portal?ids=92307486&startindex=20 "View available keyboard shortcuts \(Type '?'\)")
  ...
  * [](https://outerspace.stsci.edu/label/MASTDOCS/portal?ids=92307486&startindex=20)
    * [Forums](https://outerspace.stsci.edu/label/MASTDOCS/portal?ids=92307486&startindex=20 "Forums")
...
[ ](https://outerspace.stsci.edu/label/MASTDOCS/portal?ids=92307486&startindex=20 "Open page in fullscreen \( Type 'F', shift + f \)")
Settings
  * [See content from all spaces](https://outerspace.stsci.edu/label/portal+portal)
...
#  Labeled content 
Related Labels
  * [subscription](https://outerspace.stsci.edu/label/MASTDOCS/portal+portal+subscription)
  * [video_demo](https://outerspace.stsci.edu/label/MASTDOCS/portal+portal+video_demo)
  * [download](https://outerspace.stsci.edu/label/MASTDOCS/download+portal+portal)
  * [target_list](https://outerspace.stsci.edu/label/MASTDOCS/portal+portal+target_list)
  * [doi](https://outerspace.stsci.edu/label/MASTDOCS/doi+portal+portal)
  * [virtual_observatory](https://outerspace.stsci.edu/label/MASTDOCS/portal+portal+virtual_observatory)
  * [hst](https://outerspace.stsci.edu/label/MASTDOCS/hst+portal+portal)
  * [api](https://outerspace.stsci.edu/label/MASTDOCS/api+portal+portal)
  * [footprints](https://outerspace.stsci.edu/label/MASTDOCS/footprints+portal+portal)
  * [data-selection](https://outerspace.stsci.edu/label/MASTDOCS/data-selection+portal+portal)
  * [user-account](https://outerspace.stsci.edu/label/MASTDOCS/portal+portal+user-account)
  * [data-retrieval](https://outerspace.stsci.edu/label/MASTDOCS/data-retrieval+portal+portal)
  * [jwst](https://outerspace.stsci.edu/label/MASTDOCS/jwst+portal+portal)
  * [mast](https://outerspace.stsci.edu/label/MASTDOCS/mast+portal+portal)
  * [keywords](https://outerspace.stsci.edu/label/MASTDOCS/keywords+portal+portal)
  * [unrestored-unknown-attachment](https://outerspace.stsci.edu/label/MASTDOCS/portal+portal+unrestored-unknown-attachment)
  * [jdaviz](https://outerspace.stsci.edu/label/MASTDOCS/jdaviz+portal+portal)
  * [ftp](https://outerspace.stsci.edu/label/MASTDOCS/ftp+portal+portal)
...
Aug 30, 2021 •  [Jinmi Yoon](https://outerspace.stsci.edu/display/~jyoon%0A)
    ...
    * [portal](https://outerspace.stsci.edu/label/MASTDOCS/portal)
  * Page:
[Data Selection](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771408/Data+Selection)
Aug 30, 2021 •  [Jinmi Yoon](https://outerspace.stsci.edu/display/~jyoon%0A)
    * [mast](https://outerspace.stsci.edu/label/MASTDOCS/mast)
    * [jwst](https://outerspace.stsci.edu/label/MASTDOCS/jwst)
    ...
    * [portal](https://outerspace.stsci.edu/label/MASTDOCS/portal)
  * Page:
[Data Search](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771354/Data+Search)
Aug 30, 2021 •  [Jinmi Yoon](https://outerspace.stsci.edu/display/~jyoon%0A)
    * [mast](https://outerspace.stsci.edu/label/MASTDOCS/mast)
    * [jwst](https://outerspace.stsci.edu/label/MASTDOCS/jwst)
    * [keywords](https://outerspace.stsci.edu/label/MASTDOCS/keywords)
    * [portal](https://outerspace.stsci.edu/label/MASTDOCS/portal)
  * Page:
...
Aug 30, 2021 •  [Jinmi Yoon](https://outerspace.stsci.edu/display/~jyoon%0A)
    ...
    * [portal](https://outerspace.stsci.edu/label/MASTDOCS/portal)
  * Page:
[Linkages in the Portal](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771325/Linkages+in+the+Portal)
Aug 23, 2021 •  [Richard A. Shaw](https://outerspace.stsci.edu/display/~shaw%0A)
    * [mast](https://outerspace.stsci.edu/label/MASTDOCS/mast)
    * [jwst](https://outerspace.stsci.edu/label/MASTDOCS/jwst)
    * [portal](https://outerspace.stsci.edu/label/MASTDOCS/portal)
  * Page:
...
Aug 23, 2021 •  [Richard A. Shaw](https://outerspace.stsci.edu/display/~shaw%0A)
  ...
  1. Prev
  2. 1
  3. [2](https://outerspace.stsci.edu/label/MASTDOCS/portal?ids=92307486&ids=92307486&startIndex=10)
  4. [3](https://outerspace.stsci.edu/label/MASTDOCS/portal?ids=92307486&ids=92307486&startIndex=20)
  5. [4](https://outerspace.stsci.edu/label/MASTDOCS/portal?ids=92307486&ids=92307486&startIndex=30)
  6. [Next](https://outerspace.stsci.edu/label/MASTDOCS/portal?ids=92307486&ids=92307486&startIndex=10)
