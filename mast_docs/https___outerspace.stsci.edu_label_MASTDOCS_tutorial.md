  * [Skip to main content](https://outerspace.stsci.edu/label/MASTDOCS/tutorial#title-heading)
  * [assistive.skiplink.to.breadcrumbs](https://outerspace.stsci.edu/label/MASTDOCS/tutorial#breadcrumbs)
  * [assistive.skiplink.to.header.menu](https://outerspace.stsci.edu/label/MASTDOCS/tutorial#rw_category_menu)
  * [assistive.skiplink.to.action.menu](https://outerspace.stsci.edu/label/MASTDOCS/tutorial#navigation)
  * [assistive.skiplink.to.quick.search](https://outerspace.stsci.edu/label/MASTDOCS/tutorial#rw_search_query)


  * [Skip to main content](https://outerspace.stsci.edu/label/MASTDOCS/tutorial#main "Skip to main content \(Type 'u' then '8'\)")
  * [Skip to search](https://outerspace.stsci.edu/label/MASTDOCS/tutorial#quick-search-query)


  * [ Log in ](https://outerspace.stsci.edu/login.action?os_destination=%2Flabel%2FMASTDOCS%2Ftutorial "Login")
  * [ Help / Tips Help ](https://outerspace.stsci.edu/label/MASTDOCS/tutorial "Help")
    * [ Online Help ](https://docs.atlassian.com/confluence/docs-95/ "Visit the Confluence documentation home")
    * [ Keyboard Shortcuts ](https://outerspace.stsci.edu/label/MASTDOCS/tutorial "View available keyboard shortcuts \(Type '?'\)")
  ...
  * [](https://outerspace.stsci.edu/label/MASTDOCS/tutorial)
    * [Forums](https://outerspace.stsci.edu/label/MASTDOCS/tutorial "Forums")
...
[ ](https://outerspace.stsci.edu/label/MASTDOCS/tutorial "Open page in fullscreen \( Type 'F', shift + f \)")
Settings
  * [See content from all spaces](https://outerspace.stsci.edu/label/tutorial)
...
#  Labeled content 
Related Labels
  * [jwst](https://outerspace.stsci.edu/label/MASTDOCS/jwst+tutorial)
  * [mast](https://outerspace.stsci.edu/label/MASTDOCS/mast+tutorial)
  * [unrestored-unknown-attachment](https://outerspace.stsci.edu/label/MASTDOCS/tutorial+unrestored-unknown-attachment)
  * [jwst_rehearsal](https://outerspace.stsci.edu/label/MASTDOCS/jwst_rehearsal+tutorial)
