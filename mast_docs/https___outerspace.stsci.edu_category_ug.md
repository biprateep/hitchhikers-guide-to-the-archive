  * [Skip to main content](https://outerspace.stsci.edu/category/ug#title-heading)
  * [assistive.skiplink.to.breadcrumbs](https://outerspace.stsci.edu/category/ug#breadcrumbs)
  * [assistive.skiplink.to.header.menu](https://outerspace.stsci.edu/category/ug#rw_category_menu)
  * [assistive.skiplink.to.action.menu](https://outerspace.stsci.edu/category/ug#navigation)
  * [assistive.skiplink.to.quick.search](https://outerspace.stsci.edu/category/ug#rw_search_query)


  * [Skip to main content](https://outerspace.stsci.edu/category/ug#main "Skip to main content \(Type 'u' then '8'\)")
  * [Skip to search](https://outerspace.stsci.edu/category/ug#quick-search-query)


  * [ Log in ](https://outerspace.stsci.edu/login.action?os_destination=%2Fcategory%2Fug "Login")
  * [ Help / Tips Help ](https://outerspace.stsci.edu/category/ug "Help")
    * [ Online Help ](https://docs.atlassian.com/confluence/docs-95/ "Visit the Confluence documentation home")
    * [ Keyboard Shortcuts ](https://outerspace.stsci.edu/category/ug "View available keyboard shortcuts \(Type '?'\)")
  ...
  * [](https://outerspace.stsci.edu/category/ug)
    * [Forums](https://outerspace.stsci.edu/category/ug "Forums")
...
The following error(s) occurred:
  * The category **ug** does not exists.
