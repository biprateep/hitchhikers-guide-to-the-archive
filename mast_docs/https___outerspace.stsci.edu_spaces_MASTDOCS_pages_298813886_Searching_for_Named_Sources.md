  * [Skip to main content](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources#title-heading)
  * [assistive.skiplink.to.breadcrumbs](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources#breadcrumbs)
  * [assistive.skiplink.to.header.menu](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources#rw_category_menu)
  * [assistive.skiplink.to.action.menu](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources#navigation)
  * [assistive.skiplink.to.quick.search](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources#rw_search_query)


  * [Skip to main content](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources#main "Skip to main content \(Type 'u' then '8'\)")
  * [Skip to breadcrumbs](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources#breadcrumbs)
  * [Skip to search](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources#quick-search-query)


  * [ Log in ](https://outerspace.stsci.edu/login.action?os_destination=%2Fspaces%2FMASTDOCS%2Fpages%2F298813886%2FSearching%2Bfor%2BNamed%2BSources "Login")
  * [ Help / Tips Help ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources "Help")
    * [ Online Help ](https://docs.atlassian.com/confluence/docs-95/ "Visit the Confluence documentation home")
    * [ Keyboard Shortcuts ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources "View available keyboard shortcuts \(Type '?'\)")
  ...
  * [](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)
    * [Forums](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources "Forums")
...
[ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources "Open page in fullscreen \( Type 'F', shift + f \)")
  * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)
    * [ Remove Read Confirmation  ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)
    * [ A _t_ tachments (3)  ](https://outerspace.stsci.edu/pages/viewpageattachments.action?pageId=298813886 "View Attachments \(Type 't'\)")
    * [ Page History  ](https://outerspace.stsci.edu/pages/viewpreviousversions.action?pageId=298813886)
    * [ Page Information  ](https://outerspace.stsci.edu/pages/viewinfo.action?pageId=298813886)
    * [ Resolved comments  ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)
    * [ View in Hierarchy  ](https://outerspace.stsci.edu/pages/listpages-dirview.action?key=MASTDOCS&openId=298813886#selectedPageInHierarchy)
    * [ View Source  ](https://outerspace.stsci.edu/plugins/viewsource/viewpagesrc.action?pageId=298813886)
    * [ Export to PDF  ](https://outerspace.stsci.edu/spaces/flyingpdf/pdfpageexport.action?pageId=298813886&atl_token=7e02bacc4fc8610cc39105fafb2cd23f38ff25e7)
    * [ Export to Word  ](https://outerspace.stsci.edu/exportword?pageId=298813886)
    * [ Page Labels  ](https://outerspace.stsci.edu/plugins/userlabeltool/pagebulklabeloperations.action?pageId=298813886)
    * [ Attachment Labels  ](https://outerspace.stsci.edu/plugins/userlabeltool/pagebulkattachmentoperations.action?pageId=298813886)
    * [ Hide Inline Comments  ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/$generalUtil.getIdBasedPageUrl\($page\))
  ...
  5. [MAST Pro Tips](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/286852358/MAST+Pro+Tips "MAST Pro Tips")


[Skip to end of banner](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources#page-banner-end)
  * [](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)[](https://outerspace.stsci.edu/pages/viewpageattachments.action?pageId=298813886&metadataLink=true)
  * [Jira links](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)
  * [Workflow](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)
  * [](https://outerspace.stsci.edu/spaces/viewtrackerreport.action?key=MASTDOCS)
  * [Read Confirmation](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)


[Go to start of banner](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources#page-banner-start)
#  [Searching for Named Sources](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)
  * Created by  ![User icon: shaw](https://outerspace.stsci.edu/s/aneund/9204/1jtwilc/_/images/icons/profilepics/anonymous.svg) [Richard A. Shaw](https://outerspace.stsci.edu/display/~shaw%0A), last updated on [Apr 09, 2025](https://outerspace.stsci.edu/pages/diffpagesbyversion.action?pageId=298813886&selectedPageVersions=1&selectedPageVersions=2 "Show changes") 10 minute read 
...
Term | Usage  
---|---  
**Identifier** | **Designation** is the official [IAU term](https://cds.unistra.fr/Dic/iau-spec.html) for the name of a unique astrophysical radiation source; [SIMBAD](https://simbad.cds.unistra.fr/simbad/) uses the term **identifier**. An astrophysical source may have multiple identifiers (most often this means it is listed in multiple published catalogs), but the key point is that all identifier synonyms refer unambiguously to a _single, unique source_. Any of these names can be **resolved** (i.e., translated) to sky coordinates of the fixed source, provided the name string matches the syntax rules of the resolver service. [SIMBAD](https://simbad.cds.unistra.fr/simbad/) syntax rules permit partial identifiers (using wildcard characters), but this feature is not supported in MAST.  
...
Searches by source name in MAST are translated to searches by sky coordinates using a back-end web service called  _**SANTA**_ (_STScI Archive Name Translation Applications_). SANTA itself depends on multiple name resolution services: the major astronomical name services [SIMBAD](https://simbad.u-strasbg.fr/simbad/sim-fid) (_**S**_ et of _**I**_ dentifications, _**M**_ easurements and _**B**_ ibliography for _**A**_ stronomical _**D**_ ata; curated by CDS) and [NED](https://ned.ipac.caltech.edu/byname) (the _**N**_ ASA/IPAC _**E**_ xtragalactic _**D**_ atabase), in addition to internal services for identifiers specific to MAST. 
...
---|---|---|---  
1 | TIC | MAST translates identifiers from the [TESS Input Catalog](https://tess.mit.edu/science/tess-input-catalogue/) | `TIC 52031993`  
...
8 | NED | Uses the [NED ObjectLookup](https://ned.ipac.caltech.edu/Documents/Guides/Interface/ObjectLookup) service at NASA/IPAC |   
...
See the [SIMBAD 3-letter encodings Greek letters](https://simbad.cds.unistra.fr/guide/chA.htx)
### Ambiguous names
...
The Python package [astroquery.mast](https://astroquery.readthedocs.io/en/latest/mast/mast.html) provides a search by object name, and a way to resolve directly the source name to coordinates (_top left_).
...
* * *
# For Further Reading...
  * SIMBAD [search by identifier](https://simbad.cds.unistra.fr/simbad/sim-fid)
    * See also the [query by identifier](https://simbad.cds.unistra.fr/guide/sim-fid.htx) page, which offers specific guidance on syntax
  * NED [search by name](https://ned.ipac.caltech.edu/byname)
  * MAST [SANTA](https://mastresolver.stsci.edu/Santa-war/) name resolver
  * [IAU designations for astronomical radiation sources](https://cds.unistra.fr/Dic/iau-spec.html)
...
null
  ...
  4. [MAST Pro Tips](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/286852358/MAST+Pro+Tips)
  5. [Searching for Named Sources](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)


You are not logged in. Any changes you make will be marked as anonymous. You may want to [Log In](https://outerspace.stsci.edu/login.action?os_destination=%2Fspaces%2FMASTDOCS%2Fpages%2F298813886%2FSearching%2Bfor%2BNamed%2BSources) if you already have an account.
search
attachments
weblink
advanced
...
image-attributes
image-effects
  * [ Paragraph ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)
    * [Paragraph](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)
    * [Heading 1](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)
    * [Heading 2](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)
    * [Heading 3](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)
    * [Heading 4](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)
    * [Heading 5](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)
    * [Heading 6](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)
    * [Preformatted](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)
    * [Quote](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)


  * [ Bold ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)
  * [ Italic ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)
  * [ Underline ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)
  * [Color picker](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)
[More colors](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)
    ...
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)
  * [ Formatting ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)
    * [ Clear formatting ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)


  * [ Bullet list ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)
  * [ Numbered list ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)


  * [ Task list ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)


  * [ Outdent ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)
  * [ Indent ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)


  * [ Align left ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)
  * [ Align center ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)
  * [ Align right ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)


  * [ Page layout ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)


  * [ Link ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)


  * [ Table ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)


  * [ Insert ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)
Insert content
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)
...
Insert macro
    ...
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)
    * [ Other macros ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)


  * [ Page layout ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)
    * [ No layout ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)
    * [ Two column (simple) ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)
    * [ Two column (simple, left sidebar) ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)
    * [ Two column (simple, right sidebar) ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)
    * [ Three column (simple) ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)
    * [ Two column ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)
    * [ Two column (left sidebar) ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)
    * [ Two column (right sidebar) ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)
    * [ Three column ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)
    * [ Three column (left and right sidebars) ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)


  * [ Undo ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)
  * [ Redo ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)


  * [ Find/Replace ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)


  * [ Keyboard shortcuts help ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)


You are not logged in. Any changes you make will be marked as anonymous. You may want to [Log In](https://outerspace.stsci.edu/login.action?os_destination=%2Fspaces%2FMASTDOCS%2Fpages%2F298813886%2FSearching%2Bfor%2BNamed%2BSources) if you already have an account.
This page is also being edited by 
If you are unable to use this CAPTCHA please [contact your administrator](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/administrators.action) for assistance.![CAPTCHA image](https://outerspace.stsci.edu/jcaptcha?id=348155953)
Edit
Save
Close
  * [Preview](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)
  * [View changes](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)


  * [Revert to last published version](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/298813886/Searching+for+Named+Sources)
