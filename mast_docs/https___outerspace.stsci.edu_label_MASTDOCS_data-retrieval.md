  * [Skip to main content](https://outerspace.stsci.edu/label/MASTDOCS/data-retrieval#title-heading)
  * [assistive.skiplink.to.breadcrumbs](https://outerspace.stsci.edu/label/MASTDOCS/data-retrieval#breadcrumbs)
  * [assistive.skiplink.to.header.menu](https://outerspace.stsci.edu/label/MASTDOCS/data-retrieval#rw_category_menu)
  * [assistive.skiplink.to.action.menu](https://outerspace.stsci.edu/label/MASTDOCS/data-retrieval#navigation)
  * [assistive.skiplink.to.quick.search](https://outerspace.stsci.edu/label/MASTDOCS/data-retrieval#rw_search_query)


  * [Skip to main content](https://outerspace.stsci.edu/label/MASTDOCS/data-retrieval#main "Skip to main content \(Type 'u' then '8'\)")
  * [Skip to search](https://outerspace.stsci.edu/label/MASTDOCS/data-retrieval#quick-search-query)


  * [ Log in ](https://outerspace.stsci.edu/login.action?os_destination=%2Flabel%2FMASTDOCS%2Fdata-retrieval "Login")
  * [ Help / Tips Help ](https://outerspace.stsci.edu/label/MASTDOCS/data-retrieval "Help")
    * [ Online Help ](https://docs.atlassian.com/confluence/docs-95/ "Visit the Confluence documentation home")
    * [ Keyboard Shortcuts ](https://outerspace.stsci.edu/label/MASTDOCS/data-retrieval "View available keyboard shortcuts \(Type '?'\)")
  ...
  * [](https://outerspace.stsci.edu/label/MASTDOCS/data-retrieval)
    * [Forums](https://outerspace.stsci.edu/label/MASTDOCS/data-retrieval "Forums")
...
[ ](https://outerspace.stsci.edu/label/MASTDOCS/data-retrieval "Open page in fullscreen \( Type 'F', shift + f \)")
Settings
  * [See content from all spaces](https://outerspace.stsci.edu/label/data-retrieval)
...
#  Labeled content 
Related Labels
  * [mission-search](https://outerspace.stsci.edu/label/MASTDOCS/data-retrieval+mission-search)
  * [data-selection](https://outerspace.stsci.edu/label/MASTDOCS/data-retrieval+data-selection)
  * [jwst](https://outerspace.stsci.edu/label/MASTDOCS/data-retrieval+jwst)
  * [mast](https://outerspace.stsci.edu/label/MASTDOCS/data-retrieval+mast)
  * [portal](https://outerspace.stsci.edu/label/MASTDOCS/data-retrieval+portal)
