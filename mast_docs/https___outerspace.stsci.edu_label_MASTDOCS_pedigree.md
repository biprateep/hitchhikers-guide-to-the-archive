  * [Skip to main content](https://outerspace.stsci.edu/label/MASTDOCS/pedigree#title-heading)
  * [assistive.skiplink.to.breadcrumbs](https://outerspace.stsci.edu/label/MASTDOCS/pedigree#breadcrumbs)
  * [assistive.skiplink.to.header.menu](https://outerspace.stsci.edu/label/MASTDOCS/pedigree#rw_category_menu)
  * [assistive.skiplink.to.action.menu](https://outerspace.stsci.edu/label/MASTDOCS/pedigree#navigation)
  * [assistive.skiplink.to.quick.search](https://outerspace.stsci.edu/label/MASTDOCS/pedigree#rw_search_query)


  * [Skip to main content](https://outerspace.stsci.edu/label/MASTDOCS/pedigree#main "Skip to main content \(Type 'u' then '8'\)")
  * [Skip to search](https://outerspace.stsci.edu/label/MASTDOCS/pedigree#quick-search-query)


  * [ Log in ](https://outerspace.stsci.edu/login.action?os_destination=%2Flabel%2FMASTDOCS%2Fpedigree "Login")
  * [ Help / Tips Help ](https://outerspace.stsci.edu/label/MASTDOCS/pedigree "Help")
    * [ Online Help ](https://docs.atlassian.com/confluence/docs-95/ "Visit the Confluence documentation home")
    * [ Keyboard Shortcuts ](https://outerspace.stsci.edu/label/MASTDOCS/pedigree "View available keyboard shortcuts \(Type '?'\)")
  ...
  * [](https://outerspace.stsci.edu/label/MASTDOCS/pedigree)
    * [Forums](https://outerspace.stsci.edu/label/MASTDOCS/pedigree "Forums")
...
[ ](https://outerspace.stsci.edu/label/MASTDOCS/pedigree "Open page in fullscreen \( Type 'F', shift + f \)")
Settings
  * [See content from all spaces](https://outerspace.stsci.edu/label/pedigree)
...
#  Labeled content 
Related Labels
  * [calibration](https://outerspace.stsci.edu/label/MASTDOCS/calibration+pedigree)
  * [jwst](https://outerspace.stsci.edu/label/MASTDOCS/jwst+pedigree)
  * [notifications](https://outerspace.stsci.edu/label/MASTDOCS/notifications+pedigree)
