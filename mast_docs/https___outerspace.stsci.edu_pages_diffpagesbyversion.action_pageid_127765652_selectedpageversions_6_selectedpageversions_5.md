  * [Skip to main content](https://outerspace.stsci.edu/pages/diffpagesbyversion.action?pageid=127765652&selectedpageversions=6&selectedpageversions=5#title-heading)
  * [assistive.skiplink.to.breadcrumbs](https://outerspace.stsci.edu/pages/diffpagesbyversion.action?pageid=127765652&selectedpageversions=6&selectedpageversions=5#breadcrumbs)
  * [assistive.skiplink.to.header.menu](https://outerspace.stsci.edu/pages/diffpagesbyversion.action?pageid=127765652&selectedpageversions=6&selectedpageversions=5#rw_category_menu)
  * [assistive.skiplink.to.action.menu](https://outerspace.stsci.edu/pages/diffpagesbyversion.action?pageid=127765652&selectedpageversions=6&selectedpageversions=5#navigation)
  * [assistive.skiplink.to.quick.search](https://outerspace.stsci.edu/pages/diffpagesbyversion.action?pageid=127765652&selectedpageversions=6&selectedpageversions=5#rw_search_query)


  * [Skip to main content](https://outerspace.stsci.edu/pages/diffpagesbyversion.action?pageid=127765652&selectedpageversions=6&selectedpageversions=5#main "Skip to main content \(Type 'u' then '8'\)")
  * [Skip to breadcrumbs](https://outerspace.stsci.edu/pages/diffpagesbyversion.action?pageid=127765652&selectedpageversions=6&selectedpageversions=5#breadcrumbs)
  * [Skip to search](https://outerspace.stsci.edu/pages/diffpagesbyversion.action?pageid=127765652&selectedpageversions=6&selectedpageversions=5#quick-search-query)


  * [ Log in ](https://outerspace.stsci.edu/login.action?os_destination=%2Fpages%2Fdiffpagesbyversion.action%3Fpageid%3D127765652%26selectedpageversions%3D6%26selectedpageversions%3D5 "Login")
  * [ Help / Tips Help ](https://outerspace.stsci.edu/pages/diffpagesbyversion.action?pageid=127765652&selectedpageversions=6&selectedpageversions=5 "Help")
    * [ Online Help ](https://docs.atlassian.com/confluence/docs-95/ "Visit the Confluence documentation home")
    * [ Keyboard Shortcuts ](https://outerspace.stsci.edu/pages/diffpagesbyversion.action?pageid=127765652&selectedpageversions=6&selectedpageversions=5 "View available keyboard shortcuts \(Type '?'\)")
  ...
  * [](https://outerspace.stsci.edu/pages/diffpagesbyversion.action?pageid=127765652&selectedpageversions=6&selectedpageversions=5)
    * [Forums](https://outerspace.stsci.edu/pages/diffpagesbyversion.action?pageid=127765652&selectedpageversions=6&selectedpageversions=5 "Forums")
...
[ ](https://outerspace.stsci.edu/pages/diffpagesbyversion.action?pageid=127765652&selectedpageversions=6&selectedpageversions=5 "Open page in fullscreen \( Type 'F', shift + f \)")
  * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/127765652/HST+Search+Components)
  * [ ](https://outerspace.stsci.edu/pages/diffpagesbyversion.action?pageid=127765652&selectedpageversions=6&selectedpageversions=5)
    * [ Remove Read Confirmation  ](https://outerspace.stsci.edu/pages/diffpagesbyversion.action?pageid=127765652&selectedpageversions=6&selectedpageversions=5)
    * [ A _t_ tachments (50)  ](https://outerspace.stsci.edu/pages/viewpageattachments.action?pageId=127765652 "View Attachments \(Type 't'\)")
  ...
  5. [Components](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958262/Components)
  6. [Search Parameter Overview](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958264/Search+Parameter+Overview)
  7. [HST Search Components](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/127765652/HST+Search+Components)
...
---|---|---|---  
[Return to Page Information](https://outerspace.stsci.edu/pages/viewinfo.action?pageId=127765652)
null
