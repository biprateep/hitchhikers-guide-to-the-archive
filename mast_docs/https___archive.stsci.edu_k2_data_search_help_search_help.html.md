[Skip to Main Content](https://archive.stsci.edu/k2/data_search/help/search_help.html#content) |  | ![spacer](https://archive.stsci.edu/images/spacer.gif) | [![link to MAST page](https://archive.stsci.edu/images/mastlogo_new.gif)](https://archive.stsci.edu/index.html) | ![spacer](https://archive.stsci.edu/images/spacer.gif) | ![logo image](https://archive.stsci.edu/images/mast_signature.gif) | ![spacer](https://archive.stsci.edu/images/spacer.gif) |  | ![](https://archive.stsci.edu/images/spacer.gif)  
---|---|---|---|---|---|---  
| 
...
---|---  
![](https://archive.stsci.edu/images/spacer.gif)  
  * [ Kepler Home](https://archive.stsci.edu/kepler/)
  * [ Mission](http://kepler.nasa.gov/Mission/QuickGuide/)
  * [ Getting Started](https://archive.stsci.edu/kepler/getting_started.html)
  * [ Data Search](https://archive.stsci.edu/kepler/data_search/search.php)
  * [ Target Search](https://archive.stsci.edu/kepler/kepler_fov/search.php)
  * [ Stellar17](https://archive.stsci.edu/kepler/stellar17/search.php)
  * [ CasJobs](http://mastweb.stsci.edu/kplrcasjobs/)
  * [ FFI+ Search](https://archive.stsci.edu/kepler/ffi/search.php)

|   
![](https://archive.stsci.edu/images/spacer.gif)  
| 
  * [ Kepler Data Search](https://archive.stsci.edu/target_search_help.html)
  * [ Kepler Abstract Search](https://archive.stsci.edu/kepler/abstract.html)
  * [FAQ](https://archive.stsci.edu/mast_faq.php?mission=KEPLER)
  * [Kepler Science Center](http://keplergo.arc.nasa.gov/)
  * ![submenu](https://archive.stsci.edu/images/arrowLTR.gif) [Search & Retrieval](https://archive.stsci.edu/kepler/search_retrieve.html)
    * [Search & Retrieval page](https://archive.stsci.edu/kepler/search_retrieve.html)
    * [Data Search](https://archive.stsci.edu/kepler/data_search/search.php)
    * [Target Search](https://archive.stsci.edu/kepler/kepler_fov/search.php)
    * [Stellar Q1-Q17 Search](https://archive.stsci.edu/kepler/stellar17/search.php)
    * [FFI Display](https://archive.stsci.edu/kepler/ffi_display.php)
    * [KIC Search](https://archive.stsci.edu/kepler/kic10/search.php)
    * [Casjobs SQL](http://mastweb.stsci.edu/kplrcasjobs/)
    * [Download Options](https://archive.stsci.edu/kepler/download_options.html)
    * [Retrievals by Dataset](https://archive.stsci.edu/cgi-bin/kepler/dataset_lookup)
    * [Confirmed Planets](https://archive.stsci.edu/kepler/confirmed_planets/search.php)
    * [KOIs](https://archive.stsci.edu/kepler/koi/search.php)
    * [KOI False Positives](https://archive.stsci.edu/kepler/fpwg/search.php)
    * [KOI APP](https://archive.stsci.edu/kepler/koiapp/search.php)
    * [Eclipsing Binary Catalog](https://archive.stsci.edu/kepler/eclipsing_binaries.html)
    * [Red Giants](https://archive.stsci.edu/kepler/red_giant_release.html)
    * [Ancillary Files](https://archive.stsci.edu/kepler/ancillary.html)
    * [High Level Science Products](https://archive.stsci.edu/kepler/hlsps.html/)
  * [Download Options](https://archive.stsci.edu/kepler/download_options.html)
  * [Data Products](https://archive.stsci.edu/kepler/data_products.html)
  * ![submenu](https://archive.stsci.edu/images/arrowLTR.gif) [Documentation](https://archive.stsci.edu/kepler/documents.html)
    * [Documentation page](https://archive.stsci.edu/kepler/documents.html)
    * [Archive Manual](https://archive.stsci.edu/kepler/manuals/archive_manual.pdf)
    * [Instrument Handbook](https://archive.stsci.edu/kepler/manuals/KSCI-19033-002.pdf)
    * [Data Characteristics](https://archive.stsci.edu/kepler/manuals/Data_Characteristics.pdf)
    * [Data Processing Handbook](https://archive.stsci.edu/kepler/manuals/KSCI-19081-003-KDPH.pdf)
    * [Data Processing Pipeline](https://github.com/nasa/kepler-pipeline)
    * [Data Release Notes](https://archive.stsci.edu/kepler/data_release.html)
    * [Kepler Input Catalog paper](https://ui.adsabs.harvard.edu/abs/2011AJ....142..112B/abstract)
  * ![submenu](https://archive.stsci.edu/images/arrowLTR.gif) [Data Release Notes](https://archive.stsci.edu/kepler/data_release.html)
    * [Release Notes page](https://archive.stsci.edu/kepler/data_release.html)
    * [Release Notes 25 (Q0-Q17)](https://archive.stsci.edu/kepler/release_notes/release_notes25/KSCI-19065-002DRN25.pdf)
  * [Data Reduction & Analysis](https://archive.stsci.edu/kepler/analysis.html)
  * ![submenu](https://archive.stsci.edu/images/arrowLTR.gif) [Related Sites](https://archive.stsci.edu/kepler/sites.html)
    * [Related Sites page](https://archive.stsci.edu/kepler/sites.html)
    * [Kepler & K2 Science Center](http://keplerscience.arc.nasa.gov/)
    * [Exoplanet Archive at NExSci](http://exoplanetarchive.ipac.caltech.edu/index.html)
    * [Kepler E/PO](http://kepler.nasa.gov/)
    * [NASA/Kepler](http://www.nasa.gov/mission_pages/kepler/main/index.html)
    * [CfA KIC Home](http://www.cfa.harvard.edu/kepler/kic/kicindex.html)
    * [Exoplanet Encyclopedia](http://exoplanet.eu)
    * [All Sky Survey: Kepler FOV](http://www.astrouw.edu.pl/asas/?page=kepler)
    * [PlanetQuest](http://planetquest.jpl.nasa.gov/)
    * [NASA Confirmed Planets](http://kepler.nasa.gov/Mission/discoveries/)
    * [Exoplanet related sites](http://exoplanet.eu/sites/)
  * ![submenu](https://archive.stsci.edu/images/arrowLTR.gif) [Publications/News](https://archive.stsci.edu/kepler/publications.html)
    * [Publications page](https://archive.stsci.edu/kepler/publications.html)
    * [News](http://keplerscience.arc.nasa.gov/archives.html)
    * [Mission Manager Updates](http://www.nasa.gov/mission_pages/kepler/news/mmu.html)
    * [Kepler/K2 publications](http://keplerscience.arc.nasa.gov/publications.html)
  * [MAST Services](https://archive.stsci.edu/vo/mast_services.html)
  * [Images](https://archive.stsci.edu/kepler/images.html)
  * [Data Use Policy](https://archive.stsci.edu/data_use.html)
  * [Acknowledgments](https://archive.stsci.edu/kepler/acknowledgments.html)
...
**  
Bcause of small differences in stored floating point values, specifying a single floating point value may not return the expected results. Therefore, numerical or range operators are recommended with floating point fields queries. Integers may be requested either way.  The number of digits displayed to the right of the decimal point for floating point numbers is determined solely by the data type. If the data type is "real" only 1 digit is displayed, and for "numeric" 2 digits are displayed. "Float" data types have 3, and "double" can have up to 8 or more. 
...
By default, string searches use equals ("=") which runs faster without wild cards but implies matches must be exact. For example, searching on Target description = "Planet" will not return an entry for "Planet:Jupiter". (There are some exceptions though such as searching on Kepler Investigation ID will automatically include wild cards.) Wildcards are allowed and encouraged when an exact match is not desired, so in the previous example, searching on Planet* would return all entries beginning with the word Planet. Quotes are not necessary for string values.  Since moving to the Microsoft SQL Server database system in 2009, string searches are no longer case-sensitive. Values will still be displayed in the same case they were originally entered, but entries will be found regardless of the case of the searched string (i.e., searching for HST id "go-5916" or "GO-5916" will return the same entries).  Also, as with any data type, commas can be used to search for multiple entries. For example, to search for all O3 and B3 stars from the Skiff catalog, just enter O3*,B3*. Likewise, entering \null,<5 will return values that are either null or less than 5. However, if nulls are used with comma-separated strings, specify the strings first and in single quotes (e.g., 'hrs',\null ). 
  ...
  * **Coordinate fields** - Generally you can specify a variety of formats for Right Ascension and Declination using either decimal degrees or sexagesimal values (RA in decimal hours is also available, but only as an output format option). The allowed search formats are described in detail [below](https://archive.stsci.edu/k2/data_search/help/search_help.html#coordinates). 
...
**Object Type**
    Select targets observed by K2's special custom apertures. These are bright stars, solar system objects, stellar clusters, and microlensing events. Each was given a special custom aperture number instead of an EPIC numbers, and are not easily searched for using the rest of the form. Use <control>-click to select more than one object type to return.  
...
![](https://archive.stsci.edu/images/spacer.gif)  
| 
  * [Top of Page](https://archive.stsci.edu/k2/data_search/help/search_help.html)
  ...
  * Last Modified: Mar 25, 2020 12:12 
