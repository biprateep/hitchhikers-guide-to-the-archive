  * [Skip to main content](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide#title-heading)
  * [assistive.skiplink.to.breadcrumbs](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide#breadcrumbs)
  * [assistive.skiplink.to.header.menu](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide#rw_category_menu)
  * [assistive.skiplink.to.action.menu](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide#navigation)
  * [assistive.skiplink.to.quick.search](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide#rw_search_query)


  * [Skip to main content](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide#main "Skip to main content \(Type 'u' then '8'\)")
  * [Skip to breadcrumbs](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide#breadcrumbs)
  * [Skip to search](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide#quick-search-query)


  * [ Log in ](https://outerspace.stsci.edu/login.action?os_destination=%2Fspaces%2FMASTDOCS%2Fpages%2F104958260%2FMission%2BSearch%2BGuide "Login")
  * [ Help / Tips Help ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide "Help")
    * [ Online Help ](https://docs.atlassian.com/confluence/docs-95/ "Visit the Confluence documentation home")
    * [ Keyboard Shortcuts ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide "View available keyboard shortcuts \(Type '?'\)")
  ...
  * [](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
    * [Forums](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide "Forums")
...
[ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide "Open page in fullscreen \( Type 'F', shift + f \)")
  * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
    * [ Remove Read Confirmation  ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
    * [ A _t_ tachments (0)  ](https://outerspace.stsci.edu/pages/viewpageattachments.action?pageId=104958260 "View Attachments \(Type 't'\)")
    * [ Page History  ](https://outerspace.stsci.edu/pages/viewpreviousversions.action?pageId=104958260)
    * [ Page Information  ](https://outerspace.stsci.edu/pages/viewinfo.action?pageId=104958260)
    * [ Resolved comments  ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
    * [ View in Hierarchy  ](https://outerspace.stsci.edu/pages/listpages-dirview.action?key=MASTDOCS&openId=104958260#selectedPageInHierarchy)
    * [ View Source  ](https://outerspace.stsci.edu/plugins/viewsource/viewpagesrc.action?pageId=104958260)
    * [ Export to PDF  ](https://outerspace.stsci.edu/spaces/flyingpdf/pdfpageexport.action?pageId=104958260&atl_token=4fbee8de6962bdf33ba8100d353732d7750a69e9)
    * [ Export to Word  ](https://outerspace.stsci.edu/exportword?pageId=104958260)
    * [ Page Labels  ](https://outerspace.stsci.edu/plugins/userlabeltool/pagebulklabeloperations.action?pageId=104958260)
    * [ Attachment Labels  ](https://outerspace.stsci.edu/plugins/userlabeltool/pagebulkattachmentoperations.action?pageId=104958260)
    * [ Hide Inline Comments  ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/$generalUtil.getIdBasedPageUrl\($page\))
...
[Skip to end of banner](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide#page-banner-end)
  * [](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
  * [Jira links](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
  * [Workflow](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
  * [14,222 views](https://outerspace.stsci.edu/spaces/viewtrackerreport.action?key=MASTDOCS)
  * [Read Confirmation](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)


[Go to start of banner](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide#page-banner-start)
#  [Mission Search Guide](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
  * Created by  ![User icon: fleming](https://outerspace.stsci.edu/s/aneund/9204/1jtwilc/_/images/icons/profilepics/anonymous.svg) [Scott Fleming](https://outerspace.stsci.edu/display/~fleming%0A), last updated by  [Thomas Dutkiewicz](https://outerspace.stsci.edu/display/~tdutkiewicz%0A) on [Jul 06, 2024](https://outerspace.stsci.edu/pages/diffpagesbyversion.action?pageId=104958260&selectedPageVersions=24&selectedPageVersions=25 "Show changes") 2 minute read 


The mission search interfaces provide both a graphical user-interface (web form) and programmatic access ([via an API](https://mast.stsci.edu/search/docs/)) to mission-specific data. These interfaces allow for searches with a large set of criteria, which are customized for each mission or collection.
# Table of Contents
  * [Search Form Overview](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958261/Search+Form+Overview "Search Form Overview")
Loading..
  * [Mission Search Caveats](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/217350249/Mission+Search+Caveats "Mission Search Caveats")
...
Want to learn about the products in the search form, rather than the search form itself? Visit the [MAST Data Collection Overview](https://outerspace.stsci.edu/display/MASTDATA/MAST+Data+Collection+Overview).
...
Search interfaces are available for the following collections: 
  * [HST](https://mast.stsci.edu/search/ui/#/hst/)
  * [JWST](https://mast.stsci.edu/search/ui/#/jwst/)
  * [Classy](https://mast.stsci.edu/search/ui/#/classy/) (High-level Science Product collection)
  * [Ullyses](https://mast.stsci.edu/search/ui/#/ullyses/) (High-level Science Product collection)
...
In publications, refer to this document as:
  * MAST 2021, _MAST Mission Search Guide_ , eds. S.W. Fleming, J. Yoon, J. Kotler (Version 1; Baltimore: STScI)


Please [acknowledge the use of data](https://archive.stsci.edu/footer/data-attributions/mission-acknowledgements) obtained from MAST in publications, according to the mission(s) you use.
# For Further Reading...
  * The Python package [astroquery.mast](https://astroquery.readthedocs.io/en/latest/mast/mast.html)
...
You are not logged in. Any changes you make will be marked as anonymous. You may want to [Log In](https://outerspace.stsci.edu/login.action?os_destination=%2Fspaces%2FMASTDOCS%2Fpages%2F104958260%2FMission%2BSearch%2BGuide) if you already have an account.
search
attachments
weblink
advanced
...
image-attributes
image-effects
  * [ Paragraph ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
    * [Paragraph](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
    * [Heading 1](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
    * [Heading 2](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
    * [Heading 3](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
    * [Heading 4](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
    * [Heading 5](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
    * [Heading 6](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
    * [Preformatted](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
    * [Quote](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)


  * [ Bold ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
  * [ Italic ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
  * [ Underline ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
  * [Color picker](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
[More colors](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
    ...
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
  * [ Formatting ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
    * [ Clear formatting ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)


  * [ Bullet list ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
  * [ Numbered list ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)


  * [ Task list ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)


  * [ Outdent ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
  * [ Indent ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)


  * [ Align left ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
  * [ Align center ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
  * [ Align right ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)


  * [ Page layout ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)


  * [ Link ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)


  * [ Table ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)


  * [ Insert ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
Insert content
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
...
Insert macro
    ...
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
    * [ Other macros ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)


  * [ Page layout ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
    * [ No layout ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
    * [ Two column (simple) ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
    * [ Two column (simple, left sidebar) ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
    * [ Two column (simple, right sidebar) ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
    * [ Three column (simple) ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
    * [ Two column ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
    * [ Two column (left sidebar) ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
    * [ Two column (right sidebar) ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
    * [ Three column ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
    * [ Three column (left and right sidebars) ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)


  * [ Undo ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
  * [ Redo ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)


  * [ Find/Replace ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)


  * [ Keyboard shortcuts help ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)


You are not logged in. Any changes you make will be marked as anonymous. You may want to [Log In](https://outerspace.stsci.edu/login.action?os_destination=%2Fspaces%2FMASTDOCS%2Fpages%2F104958260%2FMission%2BSearch%2BGuide) if you already have an account.
This page is also being edited by 
If you are unable to use this CAPTCHA please [contact your administrator](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/administrators.action) for assistance.![CAPTCHA image](https://outerspace.stsci.edu/jcaptcha?id=-2063664190)
Edit
Save
Close
  * [Preview](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
  * [View changes](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)


  * [Revert to last published version](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/104958260/Mission+Search+Guide)
