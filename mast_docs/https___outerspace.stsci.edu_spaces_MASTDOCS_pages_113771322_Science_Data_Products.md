  * [Skip to main content](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products#title-heading)
  * [assistive.skiplink.to.breadcrumbs](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products#breadcrumbs)
  * [assistive.skiplink.to.header.menu](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products#rw_category_menu)
  * [assistive.skiplink.to.action.menu](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products#navigation)
  * [assistive.skiplink.to.quick.search](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products#rw_search_query)


  * [Skip to main content](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products#main "Skip to main content \(Type 'u' then '8'\)")
  * [Skip to breadcrumbs](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products#breadcrumbs)
  * [Skip to search](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products#quick-search-query)


  * [ Log in ](https://outerspace.stsci.edu/login.action?os_destination=%2Fspaces%2FMASTDOCS%2Fpages%2F113771322%2FScience%2BData%2BProducts "Login")
  * [ Help / Tips Help ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products "Help")
    * [ Online Help ](https://docs.atlassian.com/confluence/docs-95/ "Visit the Confluence documentation home")
    * [ Keyboard Shortcuts ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products "View available keyboard shortcuts \(Type '?'\)")
  ...
  * [](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
    * [Forums](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products "Forums")
...
[ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products "Open page in fullscreen \( Type 'F', shift + f \)")
  * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
    * [ Remove Read Confirmation  ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
    * [ A _t_ tachments (0)  ](https://outerspace.stsci.edu/pages/viewpageattachments.action?pageId=113771322 "View Attachments \(Type 't'\)")
    * [ Page History  ](https://outerspace.stsci.edu/pages/viewpreviousversions.action?pageId=113771322)
    * [ Page Information  ](https://outerspace.stsci.edu/pages/viewinfo.action?pageId=113771322)
    * [ Resolved comments  ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
    * [ View in Hierarchy  ](https://outerspace.stsci.edu/pages/listpages-dirview.action?key=MASTDOCS&openId=113771322#selectedPageInHierarchy)
    * [ View Source  ](https://outerspace.stsci.edu/plugins/viewsource/viewpagesrc.action?pageId=113771322)
    * [ Export to PDF  ](https://outerspace.stsci.edu/spaces/flyingpdf/pdfpageexport.action?pageId=113771322&atl_token=4fbee8de6962bdf33ba8100d353732d7750a69e9)
    * [ Export to Word  ](https://outerspace.stsci.edu/exportword?pageId=113771322)
    * [ Page Labels  ](https://outerspace.stsci.edu/plugins/userlabeltool/pagebulklabeloperations.action?pageId=113771322)
    * [ Attachment Labels  ](https://outerspace.stsci.edu/plugins/userlabeltool/pagebulkattachmentoperations.action?pageId=113771322)
    * [ Hide Inline Comments  ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/$generalUtil.getIdBasedPageUrl\($page\))
...
[Skip to end of banner](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products#page-banner-end)
  * [](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
  * [Jira links](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
  * [Workflow](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
  * [2,497 views](https://outerspace.stsci.edu/spaces/viewtrackerreport.action?key=MASTDOCS)
  * [Read Confirmation](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)


[Go to start of banner](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products#page-banner-start)
#  [Science Data Products](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
  * Created by  ![User icon: shaw](https://outerspace.stsci.edu/s/aneund/9204/1jtwilc/_/images/icons/profilepics/anonymous.svg) [Richard A. Shaw](https://outerspace.stsci.edu/display/~shaw%0A), last updated on [May 14, 2024](https://outerspace.stsci.edu/pages/diffpagesbyversion.action?pageId=113771322&selectedPageVersions=14&selectedPageVersions=15 "Show changes") 4 minute read 
...
In all, the set of files per Observation could number in the hundreds or even thousands. Exactly which calibrated products are generated depends upon the configuration of the instrument that obtained the data (imaging, various forms of spectroscopy, coronagraphy), and the operating mode (time-series, dithered, moving target, etc.). See the detailed description of [Science Products](https://jwst-pipeline.readthedocs.io/en/latest/jwst/data_products/science_products.html) for more information.
The other products are useful either for evaluating the quality of the data processing, or to provide inputs in case you wish to re-process data with some or all stages of the [calibration software](https://jwst-pipeline.readthedocs.io/en/stable/index.html) on your own computer platform.
...
Note the program ID, followed by a dash, and then additional information including the instrument name and optical elements. See the article [File Naming Schemes](https://jwst-pipeline.readthedocs.io/en/latest/jwst/data_products/file_naming.html) page for details.
## File Contents
The semantic content of the files is encoded in the filename suffix (the part of the filename just preceding the file extension). For example, filenames ending with `_uncal.fits` are uncalibrated (Level-1) FITS-formatted data, while a file ending in `_cat.ecsv` is a Level-3 source catalog in ECSV format. See [MAST Data Product Types](https://outerspace.stsci.edu/spaces/MASTDATA/pages/94963707/MAST+Data+Product+Types) for a brief description of all semantic types found in MAST. See also JWST [Data Product Types](https://jwst-pipeline.readthedocs.io/en/latest/jwst/data_products/product_types.html) for the full set of suffix names, and [Science Products](https://jwst-pipeline.readthedocs.io/en/latest/jwst/data_products/science_products.html) for a detailed explanation of pipeline product contents and internal organization.
Most, but not all, data products are in [FITS format](https://fits.gsfc.nasa.gov/fits_standard.html) (FITS 4.0 Standard). See [Data Product File Formats](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/117833935/Data+Product+File+Formats) for a summary of data products and their formats, and the article on [Data Product Types](https://jwst-pipeline.readthedocs.io/en/latest/jwst/data_products/product_types.html) to learn about the detailed organization and content of each product.
# For Further Reading...
The on-line documentation in JDox and in the calibration documentation (CAL) is very detailed and comprehensive.
  * JWST [File Naming Schemes](https://jwst-pipeline.readthedocs.io/en/latest/jwst/data_products/file_naming.html) (CAL)
  * [Data Product Types](https://jwst-pipeline.readthedocs.io/en/latest/jwst/data_products/product_types.html) (CAL)
  * [Data Product File Formats](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/117833935/Data+Product+File+Formats)
  * [Science Products](https://jwst-pipeline.readthedocs.io/en/latest/jwst/data_products/science_products.html) (CAL)
...
null
  ...
  7. [Science Data Products](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)


You are not logged in. Any changes you make will be marked as anonymous. You may want to [Log In](https://outerspace.stsci.edu/login.action?os_destination=%2Fspaces%2FMASTDOCS%2Fpages%2F113771322%2FScience%2BData%2BProducts) if you already have an account.
search
attachments
weblink
advanced
...
image-attributes
image-effects
  * [ Paragraph ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
    * [Paragraph](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
    * [Heading 1](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
    * [Heading 2](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
    * [Heading 3](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
    * [Heading 4](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
    * [Heading 5](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
    * [Heading 6](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
    * [Preformatted](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
    * [Quote](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)


  * [ Bold ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
  * [ Italic ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
  * [ Underline ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
  * [Color picker](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
[More colors](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
    ...
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
  * [ Formatting ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
    * [ Clear formatting ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)


  * [ Bullet list ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
  * [ Numbered list ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)


  * [ Task list ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)


  * [ Outdent ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
  * [ Indent ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)


  * [ Align left ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
  * [ Align center ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
  * [ Align right ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)


  * [ Page layout ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)


  * [ Link ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)


  * [ Table ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)


  * [ Insert ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
Insert content
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
...
Insert macro
    ...
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
    * [ Other macros ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)


  * [ Page layout ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
    * [ No layout ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
    * [ Two column (simple) ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
    * [ Two column (simple, left sidebar) ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
    * [ Two column (simple, right sidebar) ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
    * [ Three column (simple) ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
    * [ Two column ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
    * [ Two column (left sidebar) ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
    * [ Two column (right sidebar) ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
    * [ Three column ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
    * [ Three column (left and right sidebars) ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)


  * [ Undo ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
  * [ Redo ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)


  * [ Find/Replace ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)


  * [ Keyboard shortcuts help ](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)


You are not logged in. Any changes you make will be marked as anonymous. You may want to [Log In](https://outerspace.stsci.edu/login.action?os_destination=%2Fspaces%2FMASTDOCS%2Fpages%2F113771322%2FScience%2BData%2BProducts) if you already have an account.
This page is also being edited by 
If you are unable to use this CAPTCHA please [contact your administrator](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/administrators.action) for assistance.![CAPTCHA image](https://outerspace.stsci.edu/jcaptcha?id=417202756)
Edit
Save
Close
  * [Preview](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
  * [View changes](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)


  * [Revert to last published version](https://outerspace.stsci.edu/spaces/MASTDOCS/pages/113771322/Science+Data+Products)
