  * [Skip to main content](https://outerspace.stsci.edu/spaces/MASTDOCS/overview#title-heading)
  * [assistive.skiplink.to.breadcrumbs](https://outerspace.stsci.edu/spaces/MASTDOCS/overview#breadcrumbs)
  * [assistive.skiplink.to.header.menu](https://outerspace.stsci.edu/spaces/MASTDOCS/overview#rw_category_menu)
  * [assistive.skiplink.to.action.menu](https://outerspace.stsci.edu/spaces/MASTDOCS/overview#navigation)
  * [assistive.skiplink.to.quick.search](https://outerspace.stsci.edu/spaces/MASTDOCS/overview#rw_search_query)


  * [Skip to main content](https://outerspace.stsci.edu/spaces/MASTDOCS/overview#main "Skip to main content \(Type 'u' then '8'\)")
  * [Skip to breadcrumbs](https://outerspace.stsci.edu/spaces/MASTDOCS/overview#breadcrumbs)
  * [Skip to search](https://outerspace.stsci.edu/spaces/MASTDOCS/overview#quick-search-query)


  * [ Log in ](https://outerspace.stsci.edu/login.action?os_destination=%2Fspaces%2FMASTDOCS%2Foverview "Login")
  * [ Help / Tips Help ](https://outerspace.stsci.edu/spaces/MASTDOCS/overview "Help")
    * [ Online Help ](https://docs.atlassian.com/confluence/docs-95/ "Visit the Confluence documentation home")
    * [ Keyboard Shortcuts ](https://outerspace.stsci.edu/spaces/MASTDOCS/overview "View available keyboard shortcuts \(Type '?'\)")
  ...
  * [](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)
    * [Forums](https://outerspace.stsci.edu/spaces/MASTDOCS/overview "Forums")
...
[ ](https://outerspace.stsci.edu/spaces/MASTDOCS/overview "Open page in fullscreen \( Type 'F', shift + f \)")
  * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)
    * [ Remove Read Confirmation  ](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)
    ...
    * [ Export to PDF  ](https://outerspace.stsci.edu/spaces/flyingpdf/pdfpageexport.action?pageId=94962815&atl_token=4fbee8de6962bdf33ba8100d353732d7750a69e9)
    ...
    * [ Hide Inline Comments  ](https://outerspace.stsci.edu/spaces/MASTDOCS/$generalUtil.getIdBasedPageUrl\($page\))


  1. [Pages](https://outerspace.stsci.edu/collector/pages.action?key=MASTDOCS&src=breadcrumbs-collector)


[Skip to end of banner](https://outerspace.stsci.edu/spaces/MASTDOCS/overview#page-banner-end)
  ...
  * [5,567 views](https://outerspace.stsci.edu/spaces/viewtrackerreport.action?key=MASTDOCS)
  * [Read Confirmation](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)


[Go to start of banner](https://outerspace.stsci.edu/spaces/MASTDOCS/overview#page-banner-start)
...
image-attributes
image-effects
  * [ Paragraph ](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)
    * [Paragraph](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)
    * [Heading 1](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)
    * [Heading 2](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)
    * [Heading 3](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)
    * [Heading 4](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)
    * [Heading 5](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)
    * [Heading 6](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)
    * [Preformatted](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)
    * [Quote](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)


  * [ Bold ](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)
  * [ Italic ](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)
  * [ Underline ](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)
  * [Color picker](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)
[More colors](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)
    ...
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)
  * [ Formatting ](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)
    * [ Clear formatting ](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)


  * [ Bullet list ](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)
  * [ Numbered list ](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)


  * [ Task list ](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)


  * [ Outdent ](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)
  * [ Indent ](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)


  * [ Align left ](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)
  * [ Align center ](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)
  * [ Align right ](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)


  * [ Page layout ](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)


  * [ Link ](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)


  * [ Table ](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)


  * [ Insert ](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)
Insert content
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)
...
Insert macro
    ...
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)
    * [ ](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)
    * [ Other macros ](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)


  * [ Page layout ](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)
    * [ No layout ](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)
    * [ Two column (simple) ](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)
    * [ Two column (simple, left sidebar) ](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)
    * [ Two column (simple, right sidebar) ](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)
    * [ Three column (simple) ](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)
    * [ Two column ](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)
    * [ Two column (left sidebar) ](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)
    * [ Two column (right sidebar) ](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)
    * [ Three column ](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)
    * [ Three column (left and right sidebars) ](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)


  * [ Undo ](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)
  * [ Redo ](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)


  * [ Find/Replace ](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)


  * [ Keyboard shortcuts help ](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)


You are not logged in. Any changes you make will be marked as anonymous. You may want to [Log In](https://outerspace.stsci.edu/login.action?os_destination=%2Fspaces%2FMASTDOCS%2Foverview) if you already have an account.
This page is also being edited by 
If you are unable to use this CAPTCHA please [contact your administrator](https://outerspace.stsci.edu/spaces/MASTDOCS/administrators.action) for assistance.![CAPTCHA image](https://outerspace.stsci.edu/jcaptcha?id=-2099207554)
Edit
Save
Close
  * [Preview](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)
  * [View changes](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)


  * [Revert to last published version](https://outerspace.stsci.edu/spaces/MASTDOCS/overview)
