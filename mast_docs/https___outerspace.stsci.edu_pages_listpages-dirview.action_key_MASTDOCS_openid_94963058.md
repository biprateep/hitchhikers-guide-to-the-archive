  * [Skip to main content](https://outerspace.stsci.edu/pages/listpages-dirview.action?key=MASTDOCS&openid=94963058#title-heading)
  * [assistive.skiplink.to.breadcrumbs](https://outerspace.stsci.edu/pages/listpages-dirview.action?key=MASTDOCS&openid=94963058#breadcrumbs)
  * [assistive.skiplink.to.header.menu](https://outerspace.stsci.edu/pages/listpages-dirview.action?key=MASTDOCS&openid=94963058#rw_category_menu)
  * [assistive.skiplink.to.action.menu](https://outerspace.stsci.edu/pages/listpages-dirview.action?key=MASTDOCS&openid=94963058#navigation)
  * [assistive.skiplink.to.quick.search](https://outerspace.stsci.edu/pages/listpages-dirview.action?key=MASTDOCS&openid=94963058#rw_search_query)


  * [Skip to main content](https://outerspace.stsci.edu/pages/listpages-dirview.action?key=MASTDOCS&openid=94963058#main "Skip to main content \(Type 'u' then '8'\)")
  * [Skip to search](https://outerspace.stsci.edu/pages/listpages-dirview.action?key=MASTDOCS&openid=94963058#quick-search-query)


  * [ Log in ](https://outerspace.stsci.edu/login.action?os_destination=%2Fpages%2Flistpages-dirview.action%3Fkey%3DMASTDOCS%26openid%3D94963058 "Login")
  * [ Help / Tips Help ](https://outerspace.stsci.edu/pages/listpages-dirview.action?key=MASTDOCS&openid=94963058 "Help")
    * [ Online Help ](https://docs.atlassian.com/confluence/docs-95/ "Visit the Confluence documentation home")
    * [ Keyboard Shortcuts ](https://outerspace.stsci.edu/pages/listpages-dirview.action?key=MASTDOCS&openid=94963058 "View available keyboard shortcuts \(Type '?'\)")
  ...
  * [](https://outerspace.stsci.edu/pages/listpages-dirview.action?key=MASTDOCS&openid=94963058)
    * [Forums](https://outerspace.stsci.edu/pages/listpages-dirview.action?key=MASTDOCS&openid=94963058 "Forums")
...
[ ](https://outerspace.stsci.edu/pages/listpages-dirview.action?key=MASTDOCS&openid=94963058 "Open page in fullscreen \( Type 'F', shift + f \)")
